...
If you want to upload a more recent version, consider [this procedure](/docs/websites/frameworks/webpy-on-ubuntu-12-04-precise-pangolin#install_webpy), to install Web.py from source.
