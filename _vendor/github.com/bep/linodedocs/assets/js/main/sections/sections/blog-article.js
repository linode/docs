...
var debug = 0 ? console.log.bind(console, '[blog-article]') : function() {};

export function newBlogArticleController(searchConfig) {
	if (!searchConfig) {
		throw 'newBlogArticleController: must provide searchConfig';
	}
