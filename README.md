...
2. Download [Hugo](https://github.com/gohugoio/hugo/releases/tag/v0.52). We recommend this older version as newer versions moved to away from Black Friday to Goldmark; Docs relies on Black Friday.
