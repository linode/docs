...
7. (Optional) When the migration completes check your storage allocation meter. If you resized your Linode to a larger plan, you'll have additional un-used storage to allocate to your disks. You'll want to do this if the filesystem internal to one of your disks is running low on free space. In your Dashboard, click the "Edit" link next to the disk you'd like to add the extra free storage to. Enter a new size in the specified range and click "Save Changes".
