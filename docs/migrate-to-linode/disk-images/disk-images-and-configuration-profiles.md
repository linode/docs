...
-   **Experiment with Distributions:** New to Linux? Take different distributions out for a spin by creating a separate disk image for each flavor of Linux. Once you find a distribution you like, you can delete all of the disk images except the one with your favorite distribution.
