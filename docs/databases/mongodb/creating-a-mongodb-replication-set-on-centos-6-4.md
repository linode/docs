...
external_resources:
 ...
 - '[db.collection.insert()](http://content.mongodb.org/manual/reference/method/db.collection.insert/)'
 - '[Getting Started with the mongo Shell](http://content.mongodb.org/manual/tutorial/getting-started-with-the-mongo-shell/)'
 - '[Replication Introduction](http://content.mongodb.org/manual/core/replication-introduction/)'
---
...
[![Finding your private IP address.](/content/assets/1716-private_ip-v2.png)](/content/assets/1716-private_ip-v2.png)
...
[![Add a member to a replication set.](/content/assets/1686-add-node.png)](/content/assets/1686-add-node.png)
