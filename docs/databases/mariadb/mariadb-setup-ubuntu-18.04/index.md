...
description: 'This guide shows how to install and configure the MariaDB database server on Ubuntu 18.04.'
og_description: 'MariaDB is a robust, scalable and reliable SQL Server that can serve as a drop-in replacement for MySQL. This guide shows how to install and configure it on Ubuntu 18.04.'
keywords: ["mariadb", "Ubuntu 18.04", "debian", "database", "mysql"]
...
title: How to Set Up MariaDB on Ubuntu 18.04
external_resources:
