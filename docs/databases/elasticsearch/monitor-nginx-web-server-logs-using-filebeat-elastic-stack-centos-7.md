...
The Elastic Yum package repository contains all the necessary packages for the remainder of this tutorial, so trust and install the repository package now:
