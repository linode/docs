...
[![pgAdmin on Windows installer welcome dialog](/content/assets/364-pgadmin-windows-install-1.png)](/content/assets/364-pgadmin-windows-install-1.png)

Read the license agreement and check the box below it to accept the terms. Click "Next" to continue.

[![pgAdmin on Windows installer license agreement dialog](/content/assets/365-pgadmin-windows-install-2.png)](/content/assets/365-pgadmin-windows-install-2.png)
...
[![pgAdmin on Windows installer feature selection dialog](/content/assets/366-pgadmin-windows-install-3.png)](/content/assets/366-pgadmin-windows-install-3.png)
...
[![Windows 7 system modification warning dialog](/content/assets/367-pgadmin-windows-install-4.png)](/content/assets/367-pgadmin-windows-install-4.png)
...
[![PuTTY on Windows 7 session dialog](/content/assets/368-putty-01-session.png)](/content/assets/368-putty-01-session.png)
...
[![PuTTY tunnels screen on Windows 7](/content/assets/369-putty-03-postgresql-ssh-tunnel.png)](/content/assets/369-putty-03-postgresql-ssh-tunnel.png)

The "Forwarded ports" list should now contain an entry like the one shown below.

[![PuTTY tunnels screen showing forwarded ports on Windows 7](/content/assets/370-putty-04-postgresql-ssh-tunnel-open.png)](/content/assets/370-putty-04-postgresql-ssh-tunnel-open.png)
...
[![pgAdmin III default view on Windows 7](/content/assets/372-pgadmin-windows-use-1-add-server.png)](/content/assets/372-pgadmin-windows-use-1-add-server.png)
...
[![pgAdmin III new server details dialog](/content/assets/373-pgadmin-windows-use-2-new-server-details.png)](/content/assets/373-pgadmin-windows-use-2-new-server-details.png)

You will be presented with a full view of the databases that your user account has access to.

[![pgAdmin III full database view](/content/assets/374-pgadmin-windows-use-3-database-view.png)](/content/assets/374-pgadmin-windows-use-3-database-view.png)
