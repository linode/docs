...
![How to Install MySQL on Debian 8](/content/assets/how-to-install-mysql-on-debian-8.jpg "How to Install MySQL on Debian 8")
...
![Setting the MySQL root password in Debian.](/content/assets/mysql-rootpw-debian.png)
