...
MySQL is a popular database management system, used as the data storage provider for thousands of web and server applications. This guide will help beginners get started with MySQL on Arch Linux. If you would like to deploy MySQL as part of an application stack, consider our [LEMP](/content/lemp-guides/arch-linux/) and [LAMP guides](/content/lamp-guides/).
...
Please reference our [secure MySQL remote access guide](/content/databases/mysql/mysql-ssh-tunnel) for information on connecting to your databases with local clients.
