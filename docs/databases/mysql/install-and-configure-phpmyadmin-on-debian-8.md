...
![Install and Configure phpMyAdmin on Debian 8](/content/assets/how-to-install-and-configure-phpmyadmin-on-debian-8.png)
...
3.  Set up a working LAMP stack. Please see the [LAMP on Debian 8](/content/websites/lamp/lamp-server-debian-8) guide if needed.
...
4.  Set up Apache with SSL, so your passwords will not be sent over plain text. To do so, go through the [SSL Certificates with Apache on Debian & Ubuntu](/content/security/ssl/ssl-apache2-debian-ubuntu) guide.
