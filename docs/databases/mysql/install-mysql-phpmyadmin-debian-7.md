...
external_resources:
    ...
    - '[phpMyAdmin Documentation Page](http://www.phpmyadmin.net/home_page/content.php)'
---
...
3.  Set up a working LAMP stack. Please see the [LAMP on Debian 7](/content/websites/lamp/lamp-server-on-debian-7-wheezy) guide if needed.
