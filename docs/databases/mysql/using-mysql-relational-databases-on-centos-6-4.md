...
description: 'Getting started with MySQL on CentOS 6.5'
...
title: 'Getting started with MySQL on CentOS 6.5'
external_resources:
...
MySQL is a popular database management system used for web and server applications. This guide will introduce how to install, configure and manage MySQL on a Linode running CentOS 6.5.
...
1.  Issue the following commands to install MySQL and tell it which runlevels to start on:
...
3. Use the following commands to reset root's password. Replace "password" with something of your choice. 
...
1. Download MySQL Tuner to your Linode user's home directory.
