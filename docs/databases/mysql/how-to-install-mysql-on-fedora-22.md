...
description: 'Getting started with MySQL on Fedora 22'
keywords: 'MySQL on Linux,Fedora 22,Fedora,cloud,cloud hosting,Linux,MySQL,database,MariaDB,install MySQL,secure MySQL,mysqltuner'
license: '[CC BY-ND 3.0](http://creativecommons.org/licenses/by-nd/3.0/us/)'
alias: ['databases/mysql/fedora-22/','databases/mysql/mysql-relational-databases-fedora-22/']
modified: Wednesday, October 7th 2015
modified_by:
  name: Tyler Nelson
published: ''
title: 'How to Install MySQL on fedora-22'
external_resources:
...
MySQL is a popular database management system used for web and server applications. This guide will introduce how to install, configure and manage MySQL on a Linode running Fedora 22.
...
2.  In the example below, `testdb` is the name of the database and `testuser` is the user.
