...
- Added the `active_promotions` property to Accounts, as returned by the View Account ([GET /account](https://www.linode.com/docs/api/account/#account-view))) endpoint. This property lists all active promotions on your account.
