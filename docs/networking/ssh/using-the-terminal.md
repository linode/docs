...
![Using the Terminal](/content/assets/using-the-terminal.png "Using the Terminal")
...
You may also wish to consider installing the `ncdu` application (with your system's [package management](/content/using-linux/package-management/) tool), which provides the file size using a curses-based file browser.

For more information about monitoring the internals of your Linode, you can refer to the [System Diagnostics](/content/tools-reference/linux-system-administration-basics#system-diagnostics) guide.
