...
-   If you often access the web using untrusted public networks or if you need to secure other applications and not just the browser, then this method will fall short and you will need to set up a VPN on your server. Take a look at one of the Linode Doc's [OpenVPN](/docs/networking/vpn/) guides for instructions about that topic.
