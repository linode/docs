...
aliases: ['/networking/native-ipv6-networking/','/networking/how-to-enable-native-ipv6-on-linux/','/networking/an-overview-of-ipv6-on-linode/']
...
{{< note >}}
The IPv6 `/116` prefix is currently not available in the Toronto, Atlanta, or Mumbai data centers.
{{</ note >}}
