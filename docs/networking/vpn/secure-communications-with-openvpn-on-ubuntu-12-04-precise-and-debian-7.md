...
[![Splash screen for TunnelBlick.](/content/assets/1359-BasicVPNTraffic.jpg)](/content/assets/1359-BasicVPNTraffic.jpg)
...
[![Splash screen for TunnelBlick.](/content/assets/1360-FullTunneling.jpg)](/content/assets/1360-FullTunneling.jpg)
...
1.  The `/etc/openvpn/easy-rsa/keys/` directory contains all of the keys and certificates for the server and its clients generated using the `easy-rsa` tools. Copy the following certificate and key files to the remote client machines, using **scp** or another [means of transferring](/content/tools-reference/linux-system-administration-basics#upload-files-to-a-remote-server):
...
2.  After starting, you will see this splash screen:
    ...
    ![Splash screen for TunnelBlick.](/content/assets/1346-tunnelblick2.png)

	At the next screen click the **I have configuration files** button.

    ![Splash screen for TunnelBlick.](/content/assets/1342-tunnelblick1.png)

3.  At the next screen, click **OpenVPN Configuration(s)**:

    [![Splash screen for TunnelBlick.](/content/assets/1347-tunnelblick3.png)](/content/assets/1347-tunnelblick3.png)
...
[![Splash screen for TunnelBlick.](/content/assets/1351-tunnelblick7.png)](/content/assets/1351-tunnelblick7.png)

A notification will show you the status as it connects:

[![Splash screen for TunnelBlick.](/content/assets/1353-tunnelblick9.png)](/content/assets/1353-tunnelblick9.png)
...
7.  You will be presented with a series of options in an ncurses menu. First, choose **yes** to prepare `/etc/resolv.conf` for dynamic updates.
    ...
    [![A curses menu.](/content/assets/1338-curses1.png)](/content/assets/1338-curses1.png)
...
8.  At the next option select **No**. This means that you will need to update `/etc/network/interfaces` but won't need to remove the workaround afterwards.
    ...
    [![A curses menu.](/content/assets/1339-curses2.png)](/content/assets/1339-curses2.png)

9.  The third menu simply warns you that a reboot will be required to prevent a known bug.

    [![A curses menu.](/content/assets/1340-curses3.png)](/content/assets/1340-curses3.png)
...
11. Now that dnsmasq is configured, you will need to add two new lines to /etc/network/interfaces. First, go to the Linode's **Remote Access** page, shown below. You'll need the IP addresses listed under **DNS Resolvers** for the `dns-nameservers` line:
    ...
    [![DNS resolvers in the Linode Manager.](/content/assets/1341-resolvers.png)](/content/assets/1341-resolvers.png)
