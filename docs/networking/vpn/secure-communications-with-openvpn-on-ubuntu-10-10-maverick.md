...
> export KEY\_COUNTRY="US" export KEY\_PROVINCE="OH" export KEY\_CITY="Oxford" export KEY\_ORG="MyOrganization" export [KEY\_EMAIL="squire@example.com](mailto:KEY_EMAIL="squire@example.com)"
