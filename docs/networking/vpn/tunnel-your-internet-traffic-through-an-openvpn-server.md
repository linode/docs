...
This gude will show you how to configure an OpenVPN server to forward all traffic it receives out to the internet, then route the responses back appropriately to client devices.
