...
{{< /file-excerpt >}}
    ...
    {{< note >}}
If you're using a CentOS version other than 7, substitute `7` in the `baseurl` in `nginx.repo` file for your CentOS version. The line's syntax is:
...
3.  Ensure NGINX is running and and enabled to start automatically on reboots:
