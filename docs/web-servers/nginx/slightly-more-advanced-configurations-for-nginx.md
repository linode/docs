...
aliases: ['web-servers/nginx/configure-nginx-for-optimized-performance/','websites/nginx/configure-nginx-for-optimized-performance','web-servers/nginx/how-to-configure-nginx/']
modified: 2018-02-09
modified_by:
  name: Linode
