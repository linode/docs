...
Create an "A" record that points your domain name to your Linode's IP address. If you're using the Linode DNS Manager interface, please refer to our [Linode DNS manager guide](/content/dns-guides/configuring-dns-with-the-linode-manager) for instructions.
