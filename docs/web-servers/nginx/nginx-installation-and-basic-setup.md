...
![NGNINX server tokens enabled](/docs/assets/nginx-basics/nginx-server-tokens-enabled.jpg "NGNINX server tokens enabled")

Server tokens disabled:

![NGINX server tokens disabled](/docs/assets/nginx-basics/404_Not_Found_Server_Tokens_Off.jpg "NGINX server tokens disabled")
