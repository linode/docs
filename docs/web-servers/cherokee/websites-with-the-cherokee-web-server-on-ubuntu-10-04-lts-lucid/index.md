...
[![The cherokee-admin web server administration interface running on an Ubuntu Linux 10.04 LTS (Lucid) Linode.](214-cherokee-ubuntu-lucid-admin-01-home.png)](214-cherokee-ubuntu-lucid-admin-01-home.png)
...
[![Session information for PuTTY.](215-cherokee-putty-01-session.png)](215-cherokee-putty-01-session.png)

Expand the "Connection -\> SSH" menus to select the "Tunnel" configuration page. Enter the values shown here:

[![Configuring an SSH tunnel for Cherokee administration in PuTTY.](216-cherokee-putty-02-tunnel.png)](216-cherokee-putty-02-tunnel.png)
...
[![Saving an SSH session for Cherokee administration in PuTTY.](217-cherokee-putty-03-saved-session.png)](217-cherokee-putty-03-saved-session.png)

Click "Open" to connect to your server and start the tunnel. You may receive a warning similar to the one shown here:

[![An SSH key alert in PuTTY.](218-cherokee-putty-04-alert.png)](218-cherokee-putty-04-alert.png)
