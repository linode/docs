...
alias: ['web-servers/cherokee/installing-cherokee-fedora-14/','websites/cherokee/websites-with-the-cherokee-web-server-on-fedora-14/']
...
It is assumed that you already have a working and up to date Fedora 14 system. If you have not followed our [getting started](/content/getting-started/) guide, we recommend that you do so prior to following these instructions.
...
[![The cherokee-admin web server administration interface running on a Fedora 13 Linode.](/content/assets/229-cherokee-fedora-13-admin-01-home.png)](/content/assets/229-cherokee-fedora-13-admin-01-home.png)
...
[![Session information for PuTTY.](/content/assets/230-cherokee-putty-01-session.png)](/content/assets/230-cherokee-putty-01-session.png)

Expand the "Connection -\> SSH" menus to select the "Tunnel" configuration page. Enter the values shown here:

[![Configuring an SSH tunnel for Cherokee administration in PuTTY.](/content/assets/231-cherokee-putty-02-tunnel.png)](/content/assets/231-cherokee-putty-02-tunnel.png)
...
[![Saving an SSH session for Cherokee administration in PuTTY.](/content/assets/232-cherokee-putty-03-saved-session.png)](/content/assets/232-cherokee-putty-03-saved-session.png)

Click "Open" to connect to your server and start the tunnel. You may receive a warning similar to the one shown here:

[![An SSH key alert in PuTTY.](/content/assets/233-cherokee-putty-04-alert.png)](/content/assets/233-cherokee-putty-04-alert.png)
