...
aliases: ['web-servers/apache/php-cgi/centos-5/','websites/apache/run-php-applications-under-cgi-with-apache-on-centos-5/']
modified: 2014-01-14
modified_by:
  name: Linode
...
You can now [configure virtual hosting](/content/web-servers/apache/apache-2-web-server-on-centos-5/#configure-apache) in accordance with the needs of your server. To install the PHP CGI binaries, issue the following command:
