...
aliases: ['web-servers/apache/proxy-configuration/multiple-webservers-proxypass-ubuntu-9-10-karmic/','websites/apache/multiple-web-servers-with-proxypass-on-ubuntu-9-10-karmic/']
modified: 2011-04-29
modified_by:
  name: Linode
...
We assume you already have Apache running on your Linode. If you don't, you may wish to review our [Apache on Ubuntu 9.10 (Karmic) guide](/content/web-servers/apache/installation/ubuntu-9-10-karmic) before proceeding. These steps should be performed as root via a shell session.
...
[![Website running under Apache on Ubuntu 9.10 (Karmic).](/content/assets/452-proxypass-apache-site.png)](/content/assets/452-proxypass-apache-site.png)

Here's the site "www.secondsite.org" being served by lighttpd via ProxyPass:

[![Website running under Lighttpd on Ubuntu 9.10 (Karmic).](/content/assets/453-proxypass-lighttpd-site.png)](/content/assets/453-proxypass-lighttpd-site.png)
...
[![Web application running under a directory via lighttpd on Ubuntu 9.10 (Karmic).](/content/assets/454-proxypass-lighttpd-directory.png)](/content/assets/454-proxypass-lighttpd-directory.png)
