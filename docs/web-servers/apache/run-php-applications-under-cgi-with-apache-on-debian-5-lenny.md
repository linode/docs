...
You can now [configure virtual hosting](/docs/web-servers/apache/installation/debian-5-lenny#configure_apache_for_named_based_virtual_hosting) in accordance with the needs of your server. To install the PHP CGI binaries, issue the following command:
