...
Before you begin installing and configuring the components described in this guide, please make sure you've followed our instructions for [setting your hostname](/content/web-servers/apache/apache-and-modwsgi-on-fedora-14). Issue the following commands to make sure it is set properly:
...
- [Deploy Django Applications with mod\_wsgi](/content/development/frameworks/django-apache-and-modwsgi-on-fedora-14)
