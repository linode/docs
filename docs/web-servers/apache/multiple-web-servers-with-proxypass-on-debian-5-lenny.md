...
aliases: ['web-servers/apache/proxy-configuration/multiple-webservers-proxypass-debian-5-lenny/','websites/apache/multiple-web-servers-with-proxypass-on-debian-5-lenny/']
modified: 2012-10-08
modified_by:
  name: Linode
...
We assume you already have Apache running on your Linode; if you don't, you may wish to review our [Apache on Debian 5 (Lenny) guide](/content/web-servers/apache/installation/debian-5-lenny) before proceeding. These steps should be performed as root via a shell session.
...
[![Website running under Apache on Debian 5 (Lenny).](/content/assets/199-proxypass-apache-site.png)](/content/assets/199-proxypass-apache-site.png)

Here's the site "www.secondsite.org" being served by lighttpd via ProxyPass:

[![Website running under Lighttpd on Debian 5 (Lenny).](/content/assets/200-proxypass-lighttpd-site.png)](/content/assets/200-proxypass-lighttpd-site.png)
...
[![Web application running under a directory via lighttpd on Debian 5 (Lenny).](/content/assets/201-proxypass-lighttpd-directory.png)](/content/assets/201-proxypass-lighttpd-directory.png)
