...
This additional layer of security reduces the risk that an unauthorized individual can gain access to your Linode account. **Linode highly recommends enabling 2FA**.
...
{{< note >}}
If you *do not* have 2FA enabled and have not logged into your account in 90 days, a one-time passcode (OTP) is sent to the email address associated with your user account. You have 60 minutes to complete your login attempt, after which the code expires. If this happens, you can attempt another login to generate a new OTP and have the new code sent to your user's email.

**Having 2FA enabled bypasses this security feature.**
{{< /note >}}
