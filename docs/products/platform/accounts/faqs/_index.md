...
2FA (two-factor authentication) adds a layer of security to protect your account from unauthorized access. When switching devices or 2FA applications, it's important to [reset 2FA](/docs/products/platform/accounts/guides/2fa/#switching-to-a-new-device-or-2fa-provider) before decommisioning your original device. If you weren't able to do this and are not able to log in to the Cloud Manager as a result, you will need to contact the [support](https://www.linode.com/support/) team and verify your identiy. This verification process involves answering your account security questions or, if no security questions are set on your account, providing supporting images and other information as requested by support. Review the [Recovery Procedure](/docs/products/platform/accounts/guides/2fa/#recovery-procedure) to learn more.
