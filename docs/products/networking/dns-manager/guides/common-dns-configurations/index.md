...
See the [subdomains](/docs/products/networking/dns-manager/#subdomains) section of the [DNS manager](/docs/products/networking/dns-manager/#subdomains) guide for more information.
    {{</ disclosure-note >}}
