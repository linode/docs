...
Cloud Load Balancer uses a bring-you-own certificate model. Your certificate and it's private key are directly uploaded to a vault using Cloud Manager or APIv4.
...
## Availability (NA of Beta)

Akamai Cloud Load Balancers are available in all DV5 Data Centersand across [all regions](https://www.linode.com/global-infrastructure/).
...
| -----------------| -----------------| -------| ----------| ---|
| Extra Small     | upto 50 000     |48,000| $0.14   | $93.50  |
| Small           | upto 100 000    |96,000| $0.26   |  $173.50 |
| Medium          | upto 500 000    |480,000| $1.02  | $677.92  |
| Large           | upto 1 000 000  |960,000| 2.02 |  $1344.58 |
