...
Grafana has been removed from the App Marketplace and bundled with Prometheus. This guide has been retained for reference only. For information on how to deploy and set up Grafana, see the [Deploy Prometheus and Grafana through the Linode Marketplace](/docs/products/tools/marketplace/guides/prometheus-grafana/) guide.
{{< /note >}}
