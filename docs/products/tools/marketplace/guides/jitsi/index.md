...
1.  Before you go to your app, if you filled out the optional Jitsi configuration fields:
    ...
    - In the Cloud Manager [DNS Manager](/docs/products/networking/dns-manager/#add-a-domain) there is now an entry for your domain with two `A/AAAA` records pointing to your new server. One for the domain name and one for the hostname.
