...
1.  If you filled out the optional Webmin configuration fields:
    ...
    - In the Cloud Manager [DNS Manager](/docs/products/networking/dns-manager/#add-a-domain), confirm that there is now an entry for your domain with possible subdomain, MX, and SPF records pointing to your new server.
