...
1.  Before you go to the app, if you filled out the optional VS Code configuration fields for domain:
    ...
    - In the Cloud Manager [DNS Manager](/docs/products/networking/dns-manager/#add-a-domain) there is now an entry for the domain with possible subdomain records pointing to the new server.
