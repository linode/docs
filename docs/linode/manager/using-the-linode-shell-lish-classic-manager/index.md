...
aliases: ['networking/using-the-linode-shell-lish/','using-lish-the-linode-shell/','platform/manager/using-the-linode-shell-lish-classic-manager/','platform/using-the-linode-shell-lish/','troubleshooting/using-lish-the-linode-shell/']
modified: 2019-03-11
modified_by:
  name: Linode
...
hiddenguide: true
cloud_manager_link: platform/manager/using-the-linode-shell-lish/
---
