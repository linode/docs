...
3.  Click on **Create your first data source** in the main dashboard and fill in the form as follows:

    ![Grafana Add Data Source](/docs/assets/grafana/grafana-add-datasource.png/)

4.  Click on the **Dashboards** tab and import the default dashboard. Click on the dashboard to view it:

    ![Grafana Dashboard](/docs/assets/grafana/grafana-dashboard.png/)

5.  Hover over the user icon (in the lower left side of the sidebar) and click **Preferences** to open a menu where you can replace the default admin username and password with something more secure.
