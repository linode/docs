...
description: 'This guide provides an introduction to the installation and basic setup of Graphite together with Grafana on Ubuntu
14.04.'
keywords: 'graphite,grafana,monitor,monitoring,monitoring tool,analytics'
alias: ['deploy-graphite-with-grafana-on-ubuntu-14-04/']
