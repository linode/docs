...
external_resources:
  ...
  - '[Installing Grafana on Debian/Ubuntu](http://content.grafana.org/installation/debian/)'
  - '[Adding Graphite data source to Grafana](http://content.grafana.org/datasources/graphite/)'
---
