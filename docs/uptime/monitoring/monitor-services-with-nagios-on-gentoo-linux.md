...
Before installing Nagios, you will need to ensure that your hostname is properly set by following the steps outlined in the [getting started guide](/content/getting-started/). Additionally, you will need to have a functioning [LAMP stack](/content/lamp-guides/) in order to use Nagios.
