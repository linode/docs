...
This QuickAnswer will show you how to enable the [Linode Backup Service](/backups) on your Linode. See our full [Backup Service](/docs/platform/linode-backup-service) guide for additional information.
