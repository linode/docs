---
title: Get Started
title_meta: "Getting Started with Akamai Quick Deploy Apps"
description: "Learn how to deploy and use One-Click Apps hosted on the Akamai Quick Deploy Apps."
published: 2022-03-08
modified: 2023-07-24
keywords: ['akamai quick deploy apps','get started']
tab_group_main:
    weight: 20
...
1. Follow the instructions within the guide that corresponds with your Quick Deploy App to access the application and start using it.
