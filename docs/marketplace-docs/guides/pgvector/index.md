...
- **Suggested plan:** Dedicated 16GB instance or higher for baseline development and testing with support for GPU instances. Larger plans are recommended for compute
