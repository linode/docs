...
1.  Install and configure a [LAMP stack on Debian 10](/docs/guides/how-to-install-a-lamp-stack-on-debian-10/). Follow this guide's instructions on [MySQL Setup](#mariadb-setup) instead.
