---
slug: install-and-configure-owncloud-on-ubuntu-22-04
title: "Installing and Configuring ownCloud on Ubuntu 22.04"
title_meta: "How to Install and Configure ownCloud on Ubuntu 22.04"
...
tags: ["ubuntu"]
aliases: ['/guides/how-to-install-owncloud-ubuntu-22-04/']
relations:
    platform:
...
This tutorial walks you through the steps to install ownCloud on Ubuntu 24.04, one of the most user-friendly server operating systems available. There are only a few steps to install ownCloud on Ubuntu 20.04. You [install the LAMP (Linux Apache MySQL/MariaDB PHP) stack](/docs/guides/how-to-install-a-lamp-stack-on-ubuntu-22-04/); create a database and database user; configure Apache; and set up ownCloud using its graphical user interface.
...
1. Install PHP 7.4 and all the required PHP packages. For more information, see [Officially Supported Environments](https://doc.owncloud.com/server/next/admin_manual/installation/system_requirements.html#officially-supported-environments)

        sudo apt-get install php7.4 php7.4-opcache php7.4-gd php7.4-curl php7.4-mysqlnd php7.4-intl php7.4-json php7.4-ldap php7.4-mbstring php7.4-xml php7.4-zip -y
...
1. Download ownCloud. As of writing this guide, the latest version is 10.16.0. Replace `10.16.0` with the version you want to download.

        wget https://download.owncloud.org/community/owncloud-10.16.0.tar.bz2



1. Unzip the downloaded file:

        tar -xjf owncloud-10.16.0.tar.bz2

    {{< note respectIndent=false >}}
If necessary, install `bzip2` with the command:
