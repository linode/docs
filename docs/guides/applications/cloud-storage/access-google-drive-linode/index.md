...
Before beginning, you should be familiar with our guides on [getting started](/docs/getting-started/) and [securing your server](/docs/guides/securing-your-server/), particularly if your Google Drive contains sensitive personal information. This guide is intended to be run as a non-root user, with sudo privileges required for some steps.
