...
2.  For each Linode, complete the steps in our [Getting Started](/docs/getting-started/) guide for setting your Linode's hostname and timezone. Follow the steps in our [Securing Your Server](/docs/guides/securing-your-server/) guide to create a standard user account.
