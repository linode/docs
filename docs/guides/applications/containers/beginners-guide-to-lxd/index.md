...
2.  This guide uses `sudo` wherever necessary. Follow the [Securing Your Server](/docs/guides/securing-your-server/) guide to create a limited (non-root) user account, harden SSH access, and remove unnecessary network services.
