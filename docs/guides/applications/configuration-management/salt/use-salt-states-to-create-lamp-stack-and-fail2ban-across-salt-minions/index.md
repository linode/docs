...
{{< /file >}}
    ...
    This file defines a simple Salt State using the [pkg State Module](https://docs.saltproject.io/en/latest/ref/states/all/salt.states.pkg.html). This Salt State ensures that a LAMP stack is installed across Minions.
