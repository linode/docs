...
salt-minion:
    ...
    pkgrepo.managed:
        ...
        - baseurl: https://repo.saltproject.io/py3/redhat/{{ grains['osmajorrelease'] }}/$basearch/latest
        - gpgkey: https://repo.saltproject.io/py3/redhat/{{ grains['osmajorrelease'] }}/$basearch/latest/SALTSTACK-GPG-KEY.pub
        - gpgcheck: 1
        - enabled: 1
