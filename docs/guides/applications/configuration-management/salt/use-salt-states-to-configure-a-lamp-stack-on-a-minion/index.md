...
{{< /file >}}
    ...
    The above file uses the [file](https://docs.saltproject.io/en/latest/ref/states/all/salt.states.file.html) and [service](https://docs.saltproject.io/en/latest/ref/states/all/salt.states.service.html) Salt State modules.
...
The above section used the [cmdmod](https://docs.saltproject.io/en/latest/ref/modules/all/salt.modules.cmdmod.html), [file](https://docs.saltproject.io/en/latest/ref/modules/all/salt.modules.file.html), and [cp](https://docs.saltproject.io/en/latest/ref/modules/all/salt.modules.cp.html) Salt Execution modules.

You should now have a configured LAMP stack across as many Minions as you wanted. Optionally, use [grains](https://docs.saltproject.io/en/latest/topics/targeting/grains.html) for further customization and to apply specific variables to each host.
