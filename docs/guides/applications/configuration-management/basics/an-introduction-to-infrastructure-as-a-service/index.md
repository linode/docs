...
Customers can access their virtualized infrastructure over the internet. They can use a visual dashboard or Graphical User Interface (GUI) to quickly create or modify devices, often with the push of a button. The dashboard can also be used to monitor performance, collect data, troubleshoot, and track costs. All services are provided on a pay-as-you-go model. Some organizations might develop their own private cloud rather than using a provider, but this model is typically only used by large technology companies.
...
- **High-performance and specialized computing:** The cost of buying high-performance equipment capable of specialized tasks might otherwise be prohibitive for smaller firms. IaaS enables smaller firms to access advanced systems capable of handling data analysis, computer modeling, and 3-D graphics.
...
- Consider how any existing databases and servers should be migrated using one of the techniques in the [Migration Strategies](/docs/guides/an-introduction-to-infrastructure-as-a-service/#migration-strategies) section.
