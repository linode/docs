...
author:
    name: Linode
description: 'With this guide, you will learn how to efficiently use Puppet modules to manage files and services, create templates, and store data in Hiera on Ubuntu 18.04 "Master".'
