...
1. Create a new Debian 9 Linode. Follow our [Getting Started](/docs/getting-started/) guide to deploy the Linode, and then follow the [Securing Your Server](/docs/guides/securing-your-server/) guide. Be sure to create a [limited  Linux user with sudo privileges](/docs/guides/securing-your-server/#add-a-limited-user-account) on your server. All commands in this guide are to be run from a sudo user.
