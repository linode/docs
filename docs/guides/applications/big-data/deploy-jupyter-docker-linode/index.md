...
1.  Follow the instructions in our previous guide on Jupyter/Docker workflows, [Simplify Multi-Container Orchestration with Docker Compose](/docs/guides/application/big-data/multi-container-orchestration-docker-compose/) to set up the required examples.
