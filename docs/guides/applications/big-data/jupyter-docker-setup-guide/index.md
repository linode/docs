...
This article is the first installment in a series of guides that cover using Jupyter and Docker together. To expand on the knowledge gained here, check out the second article in our series [Managing Jupyter Data in Docker Images and Containers](/docs/guides/manage-jupyter-data-docker/).