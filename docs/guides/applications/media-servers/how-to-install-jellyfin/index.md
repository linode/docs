...
1. If you have not set up your Linode yet, check out our [Getting Started](/docs/products/platform/accounts/get-started/) guide and complete the steps for setting your Linode’s hostname and timezone.
