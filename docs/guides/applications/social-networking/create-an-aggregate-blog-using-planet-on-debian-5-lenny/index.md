...
description: 'This guide will show you how to use The Planet feed aggregator to provide an overview of a community by collecting all feeds produced by a community on Debian 5 "Lenny".'
