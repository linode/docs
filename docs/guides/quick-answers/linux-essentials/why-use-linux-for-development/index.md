...
- [Create a Linode](https://techdocs.akamai.com/cloud-computing/docs/getting-started) and work with the Linux command line remotely. The Linode platform offers a fast and cost-effective way to create Linux servers. You can easily create a Linode, test something out, then restart with a fresh Linode to try something else out.
