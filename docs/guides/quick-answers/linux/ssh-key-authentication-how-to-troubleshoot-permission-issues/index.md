...
This section covers the situation where the client does not have the correct private key and password authentication is not enabled on the server. In this case, use the [Linode Shell](https://techdocs.akamai.com/cloud-computing/docs/access-your-system-console-using-lish), also known as the LISH Console, to access the Linode.

1. Log in to the Linode using the [LISH Console](https://techdocs.akamai.com/cloud-computing/docs/access-your-system-console-using-lish). The LISH Console can be accessed from the [*Linode Cloud Manager*](https://cloud.linode.com/). Select the appropriate Linode, and click the **Launch LISH Console** link at the top right-hand side of the page.
