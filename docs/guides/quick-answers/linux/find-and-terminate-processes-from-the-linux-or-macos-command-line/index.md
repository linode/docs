...
For a more information on `kill` and `killall`, see our guide on how to [Use Killall and Kill Commands to Stop Processes on Linux](/cloud/guides/use-killall-and-kill-to-stop-processes-on-linux/).
