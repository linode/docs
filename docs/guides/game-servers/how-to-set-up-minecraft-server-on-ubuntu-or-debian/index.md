...
=======
    ...
    - In Debian 10:
        ...
        sudo apt install default-jre
>>>>>>> c35fb06a66039e3d1ab1ed964978fe6810240beb
...
2.  Create a new folder name `minecraft` and download the latest version of the Minecraft Multiplayer Server from [Minecraft.net](https://minecraft.net/) to this directory. Replace the URL in this example to match the current version:
