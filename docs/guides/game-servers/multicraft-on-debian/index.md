...
description: 'This guide shows how to install and configure MultiCraft, a control panel for single or multiple Minecraft servers, on a Linode running Debian 7.'
