...
description: "Learn how to migrate Azure Firewall rules to Akamai Cloud Firewall. This guide covers planning, exporting, mapping rules, and traffic validation."
authors: ["Akamai"]
contributors: ["Akamai"]
...
![Architecture overview of Azure Firewall and VM network.](azure-firewall-architecture.svg)
...
Use the Azure Portal of the `az` CLI to export or list your Azure Firewall rules.
...
1.  Return to the overview page of your Resource group. Find the Azure Firewall and click on it:
    ...
    ![Azure Portal firewall details page.](azure-firewall-details-ui.png)
...
1.  On the NAT rule collection page is a list of firewall rules:
...
![Inbound traffic routing through Azure Firewall to VM.](inbound-routing-diagram.svg)
