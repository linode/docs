...
|:--------------|:------------|
| **Select an Image** | Ubuntu 20.04 LTS is currently the only image supported by the MySQL Marketplace App, and it is pre-selected on the Linode creation page. *Required*. |
