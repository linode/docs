...
| **Email** | The email address to use for the domain's SOA record. This is only needed when using a custom domain. |
...
|:--------------|:------------|
| **Select an Image** | Choose an image corresponding with one of the supported distributions (listed above). *Required*. |
