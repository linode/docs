...
1.  [SSH into the Linode](/docs/getting-started/#connect-to-your-linode-via-ssh) and [create a limited user account](/docs/guides/securing-your-server/#add-a-limited-user-account).
