...
|:--------------|:------------|
| **Select an Image** | Debian 9 is currently the only image supported by the LAMP Marketplace App, and it is pre-selected on the Linode creation page. *Required*. |
