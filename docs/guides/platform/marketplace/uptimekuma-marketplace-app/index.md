...
aliases: ['/guides/deploying-uptimekuma-marketplace-app/']
---

[Uptime Kuma](https://github.com/louislam/uptime-kuma) is an open source alternative to tools like Asana, Trello, and Notion that helps teams, individuals, developers stay aligned and organized on their everyday tasks. With Focalboard, you can reach milestones, keep track of project notes, and achieve goals. 
...
1.  The Uptime Kuma login page will appear. From there, you can click "Create an Account" to create a username and password for your instance

Now that you’ve accessed your dashboard, check out [the official Uptime Kuma Repository](https://github.com/louislam/uptime-kuma) to learn how to further utilize your Focalboard instance.
