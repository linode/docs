...
description: "This guide will show you how to use the Linode One-Click App Marketplace to deploy a LEMP (Linux, NGINX, MySQL, PHP) stack on a Linode running Linux."
