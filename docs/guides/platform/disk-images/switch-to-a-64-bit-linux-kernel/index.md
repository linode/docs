...
If you're ready to rebuild your Linode using a 64-bit distribution, you can start by following the steps to create a new disk and configuration profile in the [Managing Disks and Storage on a Linode](/docs/guides/linode-disks/#creating-a-disk) and [Managing Configuration Profiles on a Linode](/docs/guides/linode-configuration-profiles/#creating-a-configuration-profile) guide. After a new disk and configuration profile has been created, you can copy your data to the new 64-bit version and then delete your old profile and disks.
