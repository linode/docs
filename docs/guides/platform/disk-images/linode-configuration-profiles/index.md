...
description: In this walkthrough, we explain how to create and manage configuration profiles for Linode, including details on each setting and its recommended value.
og_description: In this walkthrough, we explain how to create and manage configuration profiles for Linode, including details on each setting and its recommended value.
