...
- [Install Seafile with NGINX on Ubuntu 16.04](/docs/guides/install-seafile-with-nginx-on-ubuntu-1604/)

- [Install Plex Media Server on Ubuntu 16.04](/docs/guides/install-plex-media-server-on-ubuntu-18-04/)

- [Big Data in the Linode Cloud: Streaming Data Processing with Apache Storm](/docs/guides/big-data-in-the-linode-cloud-streaming-data-processing-with-apache-storm/)

- [Using Subsonic to Stream Media From Your Linode](/docs/guides/install-subsonic-media-server-on-ubuntu-or-debian/)

- [Install GitLab on Ubuntu 14.04](/docs/guides/install-gitlab-on-ubuntu-14-04-trusty-tahr/)
