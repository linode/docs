...
1. Select an option for **Billing Access** permissions. These options are as follows:
    ...
    - **Read Only**: The user can [View Billing Info](/docs/guides/manage-billing-in-cloud-manager/#viewing-invoices-and-payments), receive copies of all invoices, and receive emails related to payments.
    - **Read-Write**: The user has full access to [Billing Information](/docs/guides/manage-billing-in-cloud-manager/), can make payments, edit billing information, view billing information, receive copies of all invoices, and receive email related to payments.
