...
aliases:
  [
    "/getting-started/",
    "/getting-started-classic-manager/",
    "/getting-started-new-manager/",
  ]
modified: 2019-03-08
modified_by:
  name: Linode
...
1.  Click **Create**. You will be directed back to the _Linodes_ page which will report the status of your Linode as it boots up. You can now use the Cloud Manager to:
...
- **macOS:** _Terminal.app_ comes pre-installed and can be launched from Spotlight or Launchpad.
...
1.  Find your Findrkldsjfklds, click on it's name and navigate to _Networking_.

1.  Your IPv4 and IPv6 addresses appear under the _IPv4_ and _IPv6_ sections.
...
1.  Arrow up or down to the _Region_ of your choice and press **Enter**.

1.  Press **Option+Z** (on a macOS) or **ALT+Z** (on Windows/Linux) to select the _Time Zone_.
