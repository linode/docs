---
slug: deploying-plesk-with-one-click-apps
author:
...
tags: ["linode platform","cms","one-click","cloud-manager"]
license: '[CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0)'
published: 2019-03-25
modified: 2019-03-25
modified_by:
  name: Linode
title: "How to Deploy Plesk with One-Click Apps"
h1_title: "Deploying Plesk with One-Click Apps"
contributor:
  name: Linode
external_resources:
...
aliases: ['/platform/one-click/deploying-plesk-with-one-click-apps/']
---
...
|:--------------|:------------|
| **Select an Image** | CentOS 7, Ubuntu 18.04 LTS, and Ubuntu 16.04 LTS are the images supported by Plesk One-Click Apps. *Required*. |
...
After Plesk has finished installing, you will be able to access your Plesk site over `http://` with your Linode's IPv4 address, or the domain name entered when deploying your One-Click App:
...
1.  Access your Plesk app:
    ...
    **With a Domain Name**
    ...
    If you deployed your Plesk One-Click App with a domain name and it is pointing to the Linode's IP address that is hosting your Plesk instance, then you can enter the domain name in a browser window to access your Plesk site. Ensure you are using `http://`.
