---
slug: how-to-deploy-django-with-one-click-apps
author:
...
aliases: ['/platform/one-click/how-to-deploy-django-with-one-click-apps/','/platform/one-click/deploying-django-with-one-click-apps/']
contributor:
  name: Linode
external_resources:
