...
modified_by:
  name: Linode
title: "How to Deploy Ruby on Rails with One-Click Apps"
h1_title: "Deploying Ruby on Rails with One-Click Apps"
contributor:
  name: Linode
external_resources:
...
aliases: ['/platform/one-click/deploying-ruby-on-rails-with-one-click-apps/']
---
