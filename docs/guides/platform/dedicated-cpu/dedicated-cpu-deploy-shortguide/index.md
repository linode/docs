...
1. Select a [Distribution](/docs/guides/choosing-a-distribution/), [Marketplace App](/docs/platform/marketplace/how-to-use-marketplace-apps-at-linode/), or [Image](/docs/products/tools/images/) to deploy from.
