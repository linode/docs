...
{{< note >}}
If you have [two-factor authentication](/docs/guides/user-security-controls/#two-factor-authentication) enabled, you will receive a prompt for the code after entering your password:
