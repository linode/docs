...
h1_title: "Getting Started with the Svelte Framework"
contributor:
  name: Nathaniel Stickman
...
1. Change into the new project directory, and have NPM install the project dependencies. The rest of this tutorial assumes you are in this directory for any example commands:
...
Learn more about the SvelteKit structure and the features it offers through the SvelteKit documentation linked at the end of this tutorial.
