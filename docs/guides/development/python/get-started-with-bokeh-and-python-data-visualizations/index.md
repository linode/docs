...
{{< note >}}
If you are not familiar with Pip, see our [Managing Python Packages and Versions on Linux](/cloud/guides/how-to-manage-packages-and-virtual-environments-on-linux/#what-is-pip) guide. To learn how to install Anaconda, see our [How to Install Anaconda on Ubuntu](/cloud/guides/how-to-install-anaconda/) guide.
{{< /note >}}
