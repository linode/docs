...
- **[pytest-bdd](https://pytest-bdd.readthedocs.io/en/latest/)**: Provides support for Behavior Driven Development (BDD) using a subset of the [Gherkin language](https://docs.behat.org/en/v2.5/guides/1.gherkin.html#:~:text=more%20about%20Gherkin.-,Gherkin%20Syntax,you%20use%20spaces%20for%20portability).
...
To run PyTest in Jupyter Notebook, you must use two cells, the first of which loads the required libraries, and configure the Jupyter Notebook support as shown in the example below:
