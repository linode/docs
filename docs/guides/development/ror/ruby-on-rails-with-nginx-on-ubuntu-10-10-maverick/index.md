...
If your application uses MySQL, install the database server by following our [MySQL on Ubuntu 10.10 (Maverick) guide](/cloud/databases/mysql/ubuntu-10-10-maverick). Once it's installed and configured properly, issue the following commands:
