...
4.  (Optional) Install additional dependencies for your application, such as [MySQL](/cloud/guides/how-to-install-mysql-on-debian-8/) support:
...
If your Apache virtual hosts file(s) mimics the ones create in the [Apache Web Server on Debian 8](/cloud/guides/apache-web-server-debian-8/) guide, you will have a `<VirtualHost>` block containing a `DocumentRoot` value similar to `/var/www/html/example.com/public_html/`.
