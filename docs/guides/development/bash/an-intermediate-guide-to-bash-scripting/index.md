...
| `-g` | Files exists and has the [set group ID flag](/docs/guides/modify-file-permissions-with-chmod/#how-to-use-chmod) set. |
| `-k` | File exists and has a [sticky bit flag](/docs/guides/modify-file-permissions-with-chmod/#how-to-use-chmod) set. |
...
| `-u` | File exists and its [set user ID flag](/docs/guides/modify-file-permissions-with-chmod/#how-to-use-chmod) is set. |
