...
1. Install SonarQube
    ...
    1. Install PostgreSQL
        ...
        - **?** Debian and Ubuntu; see the section on installing from the PostgreSQL APT repository in our guide [Installing and Using PostgreSQL on Ubuntu 20.04](/docs/guides/how-to-install-use-postgresql-ubuntu-20-04/#installing-postgresql-from-the-postgresql-apt-repository)
        ...
        - CentOS and Fedora; see the section on installing from the PostgreSQL YUM repository in our guide [Install and Use PostgreSQL on CentOS 8](/docs/guides/centos-install-and-use-postgresql/#install-postgresql-from-the-postgresql-yum-repository)
            ...
            Check to make sure `15` is the latest version for you with
    ...
    1. Prepare the system
        ...
        OR, if systemd process to start SonarQube
    ...
    1. **?** Install FontConfig and a FreeType font (maybe libfreetype6)
