...
1.  If you want to use a custom domain name for your site, purchase a domain name from a trusted registrar and use Linode's [DNS Manager](/docs/products/networking/dns-manager/) to [add the domain](/docs/products/networking/dns-manager/#add-a-domain) and [create a domain record](/docs/products/networking/dns-manager/#add-dns-records) for it.
