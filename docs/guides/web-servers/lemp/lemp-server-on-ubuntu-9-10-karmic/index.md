...
For more in-depth installation instructions consider our [guide to installing nginx](/cloud/guides/websites-with-nginx-on-ubuntu-9-10-karmic/).
...
- [Deploy CGI and Perl Scripts with Perl-FastCGI and nginx](/cloud/guides/nginx-and-perlfastcgi-on-debian-5-lenny/)
- [Use PostgreSQL as an Alternative to MySQL for data storage](/cloud/guides/debian-5-lenny/)
- [Deploy Python Applications with uWSGI and nginx](/cloud/guides/wsgi-using-uwsgi-and-nginx-on-debian-5-lenny/)
