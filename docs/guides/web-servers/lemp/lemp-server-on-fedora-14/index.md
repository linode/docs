...
Now install and configure the [init script](/cloud/assets/558-init-rpm.sh) to make it possible to start and stop the web server more easily. Issue the following command sequence:
