...
For more in-depth installation instructions consider our [guide to installing nginx](/docs/guides/websites-with-nginx-on-ubuntu-10-10-maverick/).
...
In order to deploy PHP applications, you will need to implement the following "PHP-FastCGI" solution to allow nginx to properly handle and serve pages that contain PHP code. For a more complete introduction to this subject, consider our dedicated guide to [PHP FastCGI with Nginx](/docs/guides/nginx-and-phpfastcgi-on-ubuntu-10-10-maverick/). Begin the deployment process by issuing the following command to install the required dependencies:
...
- [Deploy CGI and Perl Scripts with Perl-FastCGI and nginx](/docs/guides/nginx-and-perlfastcgi-on-ubuntu-10-10-maverick/)
- [Use PostgreSQL as an Alternative to MySQL for data storage](/docs/guides/ubuntu-10-10-maverick/)
- [Deploy Python Applications with uWSGI and nginx](/docs/guides/wsgi-using-uwsgi-and-nginx-on-ubuntu-10-10-maverick/)
