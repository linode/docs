...
- [Deploy CGI and Perl Scripts with Perl-FastCGI and nginx](/docs/guides/nginx-and-perlfastcgi-on-ubuntu-10-04-lts-lucid/)
- [Use PostgreSQL as an Alternative to MySQL for data storage](/docs/guides/ubuntu-10-04-lucid/)
- [Deploy Python Applications with uWSGI and nginx](/docs/guides/wsgi-using-uwsgi-and-nginx-on-ubuntu-10-04-lucid/)
