...
We assume you already have Apache running on your Linode. If you don't, you may wish to review our [Apache on Ubuntu 10.04 (Lucid) guide](/cloud/web-servers/apache/installation/ubuntu-10-04-lucid) before proceeding. These steps should be performed as root via a shell session.
