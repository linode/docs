...
This guide assumes that you are familiar and comfortable with setting up [LAMP stacks](/cloud/websites/lamp) on Debian 7. If you are new to Linux server administration, you may be interested in reading our [Linux System Administration Basics](/cloud/guides/linux-system-administration-basics/) documentation series.
