...
1.  If you have not already installed the Apache HTTP server, do so:
    ...
    You can now [configure virtual hosting](/cloud/guides/apache-web-server-ubuntu-12-04/#configure-virtual-hosting) in accordance with the needs of your server.
