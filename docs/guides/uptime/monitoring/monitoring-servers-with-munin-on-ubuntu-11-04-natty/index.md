...
In most cases you will probably want to prevent the data generated by Munin from becoming publicly accessible. You can either limit access using [rule based access control](/cloud/guides/rulebased-access-control-for-apache/) so that only a specified list of IPs will be permitted access, or you can configure [HTTP Authentication](/cloud/guides/apache-access-control/) to require a password before permitting access.
