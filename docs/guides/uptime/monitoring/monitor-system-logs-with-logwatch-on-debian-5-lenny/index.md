...
description: 'This guide shows you how to use logwatch, a Linux utility used to monitor system logs and create reports for critical and non-critical events on Debian 5 "Lenny".'
