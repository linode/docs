...
Even with a low traffic site, Apache logs can become large. If your logs are routinely large, processing those logs can be time-consuming. You should consider [log rotation](/cloud/guides/use-logrotate-to-manage-log-files/) to prevent potential performance issues.
