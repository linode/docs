---
slug: installing-and-configuring-posthog-on-linode-kubernetes-engine
author:
  name: Linode Community
  email: docs@linode.com
description: 'Learn how to self-host PostHog, an all-in-one analytics tool, on LKE to measure and track usage and funnel statistics and insights.'
og_description: 'Learn how to self-host PostHog, an all-in-one analytics tool, on LKE to measure and track usage and funnel statistics and insights.'
...
modified_by:
  name: Linode
title: "Installing and Configuring PostHog on Linode Kubernetes Engine"
...
Following are some of Posthog's most popular analytics features. A full list of features can be seen in the [PostHog User Guide](https://posthog.com/docs/user-guides).
...
### Create the values.yaml File and Install PostHog
...
If you cannot access the PostHog "preflight" page, there are certain steps to take to debug the installation. Following are a few concerns to investigate.
