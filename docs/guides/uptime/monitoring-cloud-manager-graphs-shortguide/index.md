...
-   **Disk I/O:** Watch for [disk input/output bottlenecks](/docs/products/compute/compute-instances/guides/troubleshooting-general-issues/#compute-instance-is-slow).
