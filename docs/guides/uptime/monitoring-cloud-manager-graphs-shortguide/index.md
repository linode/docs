...
-   **Disk I/O:** Watch for [disk input/output bottlenecks](https://techdocs.akamai.com/cloud-computing/docs/troubleshooting-general-issues-on-compute-instances#compute-instance-is-slow).
