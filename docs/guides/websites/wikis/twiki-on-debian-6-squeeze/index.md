...
description: 'This guide will show you how to install and configure a structured wiki to share, store, and work with different types of information with TWiki on Debian 6 "Squeeze".'
