...
This guide assumes that you already have a working [LAMP stack](/cloud/guides/install-lamp-stack-on-ubuntu-16-04/) running on Ubuntu. Your web accessible `DocumentRoot` should be located in `/var/www/html/example.com/public_html/`. You should be connected to your server via SSH and logged in as root.
