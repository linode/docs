...
- [Exim Send Only MTA](/docs/guides/sendonly-mail-server-with-exim-on-ubuntu-10-10-maverick/)
- [Postfix Mail Gateway MTA](/docs/guides/basic-postfix-email-gateway-on-ubuntu-10-10-maverick/)
