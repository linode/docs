...
- [Exim Send Only MTA](/cloud/guides/sendonly-mail-server-with-exim-on-ubuntu-10-10-maverick/)
- [Postfix Mail Gateway MTA](/cloud/guides/basic-postfix-email-gateway-on-ubuntu-10-10-maverick/)
