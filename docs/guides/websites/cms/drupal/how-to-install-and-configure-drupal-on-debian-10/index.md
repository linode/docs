...
{{< note >}}
If you are not using Debian 10, you can view different Linux distribution versions of this guide in the [Drupal](/cloud/guides/websites/cms/drupal/) section of our documentation site.
{{< /note >}}
...
3.  Install and configure a [LAMP stack on Debian 10](/cloud/guides/how-to-install-a-lamp-stack-on-debian-10/)
...
3.  Complete the database configuration using the DB name, username and password you created when [setting up your LAMP stack](/cloud/guides/how-to-install-a-lamp-stack-on-debian-10/) with a MySQL or MariaDB database.
