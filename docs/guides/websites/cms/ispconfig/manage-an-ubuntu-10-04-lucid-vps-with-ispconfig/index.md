...
You will be asked a series of questions during the installation; please refer to the [Postfix guide](/cloud/guides/email-with-postfix-dovecot-and-mysql-on-ubuntu-10-04-lts-lucid/) to determine what the needs of your system will be. In most cases, the defaults are fine.
