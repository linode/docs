...
You will be asked a series of questions during the installation; please refer to the [Postfix guide](/cloud/guides/email-with-postfix-courier-and-mysql-on-ubuntu-9-10-karmic/) to determine what the needs of your system will be. In most cases, the defaults are fine.
...
More information on Webalizer can be found in our [Webalizer documentation](/cloud/guides/webalizer-on-debian-5-lenny/).
...
- [Upload Files to your Linode](/cloud/guides/tools-reference/file-transfer/)
- [Limit User Access with SFTP Jails](/cloud/guides/limiting-access-with-sftp-jails-on-debian-and-ubuntu/)
