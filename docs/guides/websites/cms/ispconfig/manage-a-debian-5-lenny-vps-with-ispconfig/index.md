...
You will be asked a series of questions during the installation; please refer to the [Postfix guide](/cloud/guides/email-with-postfix-courier-and-mysql-on-debian-5-lenny/) to determine what the needs of your system will be. In most cases, the defaults are fine.
