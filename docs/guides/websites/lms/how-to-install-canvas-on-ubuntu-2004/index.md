...
Canvas uses Apache and Phusion's Passenger to serve its web pages. Phusion has its package repository, which this guide uses to install both Passenger and the Passenger module for Apache.
