...
- '[Certbot: Debianbuster Apache](https://certbot.eff.org/lets-encrypt/debianbuster-apache.html)'
---
...
1. Use Bundle to rehash the encryption key and compile Canvas's assets:
    ...
    You can start Apache back up afterward:
...
Your Canvas website is now up and running! Visit it by navigating to your server's domain name in a web browser. You are prompted to log in, which you can do using the Canvas administrator credentials you created earlier.
