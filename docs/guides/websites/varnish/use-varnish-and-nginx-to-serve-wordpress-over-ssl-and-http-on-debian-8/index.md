...
[![Nginx-Varnish-Nginx server configuration diagram](varnish-cache.png)](varnish-cache.png "Nginx-Varnish-Nginx server configuration diagram")

## Before You Begin

This tutorial assumes that you have SSH access to your Linode running Debian 8 (Jessie). Before you get started:

1.  Complete the steps in our [Getting Started](/docs/getting-started/) and [Securing your Server](/docs/guides/securing-your-server/) guides. You'll need a standard user account with `sudo` privileges for many commands in this guide.
