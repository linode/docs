...
description: 'This guide will show you how to install, setup, configure, and manage a online storefront where you can sell anything with OpenCart on Debian 6 "Squeeze".'
