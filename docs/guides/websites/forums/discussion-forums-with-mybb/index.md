...
Before we begin, we assume you have followed the steps outlined in the [Setting Up and Securing a Compute Instance](https://techdocs.akamai.com/cloud-computing/docs/set-up-and-secure-a-compute-instance). You will also need a working [LAMP stack](/cloud/lamp-guides/).
