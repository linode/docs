...
For this guide, we'll assume you've already followed the [Setting Up and Securing a Compute Instance](https://techdocs.akamai.com/cloud-computing/docs/set-up-and-secure-a-compute-instance) guide and have a working [LAMP stack](/docs/guides/how-to-install-a-lamp-stack-on-debian-11/) on your Linode. You should be connected to your server via SSH and logged in as root.
