...
{{< note >}}
Ensure you complete the steps in this section using your limited user account. This account will need [sudo privileges](/docs/guides/securing-your-server/#debian), if it does not already have them.
{{</ note >}}
