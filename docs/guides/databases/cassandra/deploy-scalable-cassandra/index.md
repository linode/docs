...
modified_by:
  name: 'Andrew Lescher'
h1_title: 'How to Install Apache Cassandra on Ubuntu 17.04 and CentOS 7'
title: 'How to Install Apache Cassandra on Ubuntu & CentOS'
enable_h1: true
contributor:
   name: Andrew Lescher
...
![Deploy a scalable and development driven NoSQL DB with Cassandra](Apache_Cassandra.png)
