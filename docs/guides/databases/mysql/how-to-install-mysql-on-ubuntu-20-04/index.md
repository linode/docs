...
description: 'How to Install and Configure MySQL Server on Ubuntu 20.04 Linux'
og_description: 'How to Install and Configure  MySQL Server on Ubuntu 20.04 Linux'
...
5 rows in set (0.00 sec)
    ...
    {{< /output >}}
4. Indicate the database that you want to work with using the `USE` command.
