...
description: 'This guide shows how to get started with the popular database management app - MySQL - as well as how to install the application on Ubuntu 14.04.'
