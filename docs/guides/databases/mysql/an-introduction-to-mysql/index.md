...
For instance, a simplified `Students` table can be defined using the following structure. The top row represents the names of the columns in the table. The table below currently has two rows of data, one for each student.
