...
description: 'This guide shows you how to connect Metabase, a datae xploration tool that makes analytics easy, to a local MySQL server and deploy through a reverse proxy on NGINX.'
og_description: 'This guide shows you how to connect Metabase, a data exploration tool that makes analytics easy, to a local MySQL server and deploy through a reverse proxy on NGINX.'
