---
slug: an-introduction-to-mongodb
author:
...
modified_by:
  name: Linode
title: "What Is MongoDB and Why Use It | Linode"
h1_title: "What Is MongoDB and Why Use It | Linode"
enable_h1: true
contributor:
  name: Jeff Novotny
external_resources:
...
For information on how to install MongoDB on a Linode, see the [*Linode MongoDB installation guide for CentOS*](https://www.linode.com/docs/guides/install-mongodb-on-centos-7/), or [*for Ubuntu*](https://www.linode.com/docs/guides/install-mongodb-on-ubuntu-16-04/).
...
The most popular type of database is the *Relational DataBase Management System* (RDBMS). RDBMS applications use the SQL programming language to store and retrieve data and to administer the database. An RDBMS, or SQL-based, database uses tables, rows, and columns in the following manner.
...
On a system level, MongoDB differs from a typical RDBMS in several major ways. To make a sound decision on choosing a NoSQL vs an SQL database, consider the following points.
...
*   MongoDB permits data to be formatted in a hierarchical manner. The value of a field can be another set of fields. Relational databases do not usually allow this type of structure. The table columns store scalar data.
...
The freedom of MongoDB is very appealing, but it is important to spend some time thinking about the architecture beforehand. Decisions taken without any co-ordination or planning could result in an anarchic mess that is difficult to understand and use.
...
The MongoDB documentation includes a handy [*SQL to MongoDB Mapping Reference*](https://docs.mongodb.com/manual/reference/sql-comparison/).
...
*   MongoDB is designed with high availability in mind. It includes highly-robust and powerful replication and back up mechanisms. Different workloads can be isolated in the same cluster and data can be stored globally or locally.
