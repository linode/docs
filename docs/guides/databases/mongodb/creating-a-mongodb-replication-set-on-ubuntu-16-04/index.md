...
description: 'This guide will show you how to configure a MongoDB Replica Set (aka cluster) with primary-secondary replication and automatic failover on Ubuntu 16.04.'
...
aliases: ['/databases/mongodb/creating-a-mongodb-replication-set-on-ubuntu-16-04/']
external_resources:
