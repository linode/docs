...
After determining which database management system to use for your application, you need to decide how to deploy, configure, and manage that system in the cloud. The Akamai Cloud platform offers the following solutions:
...
The following Marketplace Apps (and Clusters) are available on the Akamai Cloud platform.
