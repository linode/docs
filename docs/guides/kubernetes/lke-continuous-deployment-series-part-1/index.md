---
slug: lke-continuous-deplpoyment-part-1
author:
...
modified_by:
  name: Linode
title: "Building a Continous Deployment Pipepline Using LKE Part 1: Introduction"
contributor:
  name: Linode
tags: ["kubernetes"]
---
...
- Internal dependencies: geo-logcursor, gitaly, gitlab-exporter, gitlab-grafana, gitlab-pages, gitlab-shell, kas, mailroom, migrations, operator, praefect, sidekiq, task-runner, webservice (these dependencies correspond to subcharts embedded in the GitLab chart)
