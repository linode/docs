...
{{< note >}}
For more information regarding these files and directories and their contents, see our [Beginner's Guide to Terraform](/cloud/guides/beginners-guide-to-terraform/)
{{< /note >}}
