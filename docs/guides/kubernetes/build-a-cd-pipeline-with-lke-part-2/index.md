...
- **Previous section:** [Part 1: Get Ready](/cloud/guides/build-a-cd-pipeline-with-lke-part-1/)
- **Next section:** [Part 3: Deploying the LKE Cluster](/cloud/guides/build-a-cd-pipeline-with-lke-part-3/)
