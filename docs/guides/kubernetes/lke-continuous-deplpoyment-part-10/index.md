---
slug: lke-continuous-deplpoyment-part-10
author:
...
modified_by:
  name: Linode
title: "Building a Continous Deployment Pipepline Using LKE Part 10: Installing metrics-server"
contributor:
  name: Linode
tags: ["kubernetes"]
---
...
- It will expose them through the Kubernetes API agregation layer (we won't say much more about that agregation layer; that's fairly advanced stuff!)
