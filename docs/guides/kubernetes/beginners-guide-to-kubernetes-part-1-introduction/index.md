...
{{< note >}}
This is the first guide in the [Beginner's Guide to Kubernetes](/cloud/guides/beginners-guide-to-kubernetes/) series that explains the major parts and concepts of Kubernetes.
{{< /note >}}
...
To continue in the [Beginner's Guide to Kubernetes](/cloud/guides/beginners-guide-to-kubernetes/) series, visit part 2:

 - [Beginner's Guide to Kubernetes, Part 1: Introduction](/cloud/guides/beginners-guide-to-kubernetes-part-1-introduction/) (You Are Here)
