...
For a more in-depth explanation of Kubernetes concepts, see our five-part [Beginner's Guide to Kubernetes](/cloud/guides/beginners-guide-to-kubernetes/).
...
-   **Hosted, Managed Kubernetes**
    ...
    {{< note >}}
    The [Linode Kubernetes Engine (LKE)](https://techdocs.akamai.com/cloud-computing/docs/linode-kubernetes-engine) is an example of this category.
    {{< /note >}}
