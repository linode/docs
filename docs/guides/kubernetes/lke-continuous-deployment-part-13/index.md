...
description: 'This guide will explain how to build a continuous deployment pipeline using a self-hosted GitLab instance within our Kubernetes cluster.'
og_description: 'This guide will explain how to build a continuous deployment pipeline using a self-hosted GitLab instance within our Kubernetes cluster.'
title: "How to Set Up a CI/CD Pipeline with GitLab"
