...
description: 'ExternalDNS is a tool that automatically manages external DNS records from within the Kubernetes cluster. We'll show you how to install and test it using Helm.'
og_description: 'ExternalDNS is a tool that automatically manages external DNS records from within the Kubernetes cluster. We'll show you how to install and test it using Helm.'
title: "How to Install ExternalDNS Using Helm"
