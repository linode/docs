...
{{< note >}}
This is the third guide in the [Beginner's Guide to Kubernetes](/cloud/guides/beginners-guide-to-kubernetes/) series that explains the major parts and concepts of Kubernetes.
{{< /note >}}
...
To continue in the [Beginner's Guide to Kubernetes](/cloud/guides/beginners-guide-to-kubernetes/) series, visit part 4:
...
- [Beginner's Guide to Kubernetes, Part 3: Objects](/cloud/guides/beginners-guide-to-kubernetes-part-3-objects/) (You Are Here)
