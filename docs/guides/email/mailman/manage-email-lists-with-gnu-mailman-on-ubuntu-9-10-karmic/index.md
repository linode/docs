...
description: 'This guide shows you how to use the GNU Mailman software to manage and moderate email listservs (aka group mailing lists) on Ubuntu 9.10 "Karmic".'
