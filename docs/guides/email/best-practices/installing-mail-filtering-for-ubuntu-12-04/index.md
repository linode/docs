...
This guide assumes you have already followed our [Email with Postfix, Dovecot, and MySQL](/cloud/guides/email-with-postfix-dovecot-and-mysql/) guides and are running Ubuntu 12.04 LTS. This guide is written for the root user, and all commands listed require root privileges.
