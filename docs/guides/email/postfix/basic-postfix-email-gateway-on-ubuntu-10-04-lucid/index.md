...
description: 'This guide will instruct you on how to configure the Postfix MTA as a basic email gateway in Ubuntu 10.04.'
...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.04 (Lucid) system.](81-postfix-courier-mysql-02-mail-server-type-2.png)](81-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.04 (Lucid) system.](82-postfix-courier-mysql-02-mail-server-type-3.png)](82-postfix-courier-mysql-02-mail-server-type-3.png)
