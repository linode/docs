...
Consider the [basic email gateway guide](/cloud/guides/basic-postfix-email-gateway-on-debian-6-squeeze/) for more information regarding Postfix virtual hosting configuration. If you need to deliver mail locally, continue for documentation of mail routing and the Dovecot POP3/IMAP server.
...
- [Basic Email Gateway with Postfix on Debian 6 (Squeeze)](/cloud/guides/basic-postfix-email-gateway-on-debian-6-squeeze/)
