...
* If you require memcached to communicate over a private network:
    ...
    2.  Configure your Linode's firewall accordingly. If you need help setting up a firewall, see [our firewall guides](/cloud/security/firewalls/) for more information.
