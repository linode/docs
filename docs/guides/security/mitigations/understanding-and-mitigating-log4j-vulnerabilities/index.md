...
If you believe a compromise has occurred, we recommend following the steps in our guide for [Recovering From a System Compromise](/cloud/guides/recovering-from-a-system-compromise/).
