...
description: "This guide will show you how to install and use Certbot with NGINX on CentOS/RHEL 7. Certbot is a tool that automates the process of requesting a signed TLS/SSL certificate through Let’s Encrypt, easily enabling HTTPS on your websites."
og_description:  "This guide will show you how to install and use Certbot with NGINX on CentOS/RHEL 7. Certbot is a tool that automates the process of requesting a signed TLS/SSL certificate through Let’s Encrypt, easily enabling HTTPS on your websites."
