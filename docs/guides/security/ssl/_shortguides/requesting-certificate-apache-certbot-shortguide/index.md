...
description: "Shortguide that outlines how to request a certificate using Certbot with an Apache web server"
license: '[CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0)'
modified: 2021-07-01
published: 2021-07-01
title: Requesting a Certificate Using Certbot with Apache Shortguide
headless: true
