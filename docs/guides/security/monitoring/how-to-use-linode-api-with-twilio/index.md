...
description: 'Twilio is an internet messaging service that can be useful for system monitoring. This guide shows a first example of embedding Linode API data in a text message using Twilio.'
og_description: 'Twilio is an internet messaging service that can be useful for system monitoring. This guide shows a first example of embedding Linode API data in a text message using Twilio.'
keywords: []
