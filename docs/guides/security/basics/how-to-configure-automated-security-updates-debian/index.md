...
The last step is to enable automatic updates is to create a new file for the auto-upgrades file: `/etc/apt/apt.conf.d/20auto-upgrades` using text editor of your choice.
