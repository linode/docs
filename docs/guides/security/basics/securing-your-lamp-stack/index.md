...
For a quick an easy way to install a LAMP stack on Linode, check out our guide on [How to Deploy a LAMP Stack with Quick Deploy Apps](/docs/marketplace-docs/guides/lamp-stack/).
