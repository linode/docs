...
author:
  name: Hackersploit
description: "In this tutorial, you will learn how to configure automated updates on Ubuntu, by using the dns-automatic tool or the Cockpit web application."
