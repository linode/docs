...
description: "This guide walks you through the core features of YUM and command commands for using YUM to install, upgrade, and remove packages on your system."
og_description: " This guide walks you through the core features of YUM and command commands for using YUM to install, upgrade, and remove packages on your system."
