...
1.  Familiarize yourself with [Lish](https://techdocs.akamai.com/cloud-computing/docs/access-your-system-console-using-lish), as most of this guide will require an out-of-band connection.
...
1.  From the Linode Cloud Manager, boot your Linode into [Rescue Mode](https://techdocs.akamai.com/cloud-computing/docs/rescue-and-rebuild), with your boot disk image as `/dev/sda`, your root disk image as `/dev/sdb`, and your swap as /`dev/sdc`.
