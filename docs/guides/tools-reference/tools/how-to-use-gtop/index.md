...
What follows is a breakdown of the parts, or widgets, of the `gtop` display. You can refer to the screenshots in the [What is gtop?](/docs/guides/how-to-use-gtop/#what-is-gtop) section above to follow along.
