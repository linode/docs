---
slug: how-to-install-streamlink-ubuntu-macos
author:
...
Streamlink lets you watch any stream inside your favorite media player such as VLC or Media Player. You can watch [YouTube](https://www.youtube.com), [Twitch](https://www.twitch.tv), or [DailyMotion](https://www.dailymotion.com/us) video streams on your desktop instead of in your browser. Aside from a cleaner experience, streaming via any desktop player has far less impact on your PCs resources leading to smoother playback.
...
1. Confirm with the installation with  **Y** and wait for the download and package installation to complete. You’re now ready to start streaming on your Ubuntu or Debian desktop computer. The section below covers those details.

{{< note >}}
If you receive a `No playable streams found on this URL` error, install Streamlink using the Python method:
...
1. If you do not have [Homebrew](https://brew.sh/) installed on your macOS, you must install it first. Install Homebrew on your macOS system:
...
1. To watch a stream using the Streamlink CLI, issue the following command. Replace the URL with your own URL.
    ...
    {{< note >}}
When using Ubuntu or Debian, you may have to to specify the video player to open the stream in. For example, to open your stream using VLC, issue the following command:
...
1. Select the desired resolution by typing the following:
