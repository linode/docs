...
This document provides an overview of `tar` and `gzip` usage, accompanied by a number of practical applications of these utilities. If you find this guide helpful, please consider our guide to [basic administration practices](/cloud/guides/linux-system-administration-basics/) or the rest of the [Tools & Reference](/cloud/guides/tools-reference/) series.
