...
Nano is included with many Linux distributions by default. However, some users may need to install Nano on Linux using the [package management](/cloud/guides/linux-package-management-overview/) tool of the distribution.
