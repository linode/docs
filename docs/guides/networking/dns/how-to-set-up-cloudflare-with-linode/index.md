...
If you were previously attacked and are setting up Cloudflare to protect yourself from continued attacks, [contact Linode Support](https://techdocs.akamai.com/cloud-computing/docs/help-and-support#contact-customer-support) and request a new IP address for your Linode for use with Cloudflare.
