---
slug: ip-failover-lelastic
author:
  name: Linode
  email: docs@linode.com
description: "Learn how to use Linode's IP Sharing feature to configure IP failover using lelastic"
keywords: ['networking','IP failover','keepalived']
license: '[CC BY-ND 4.0](https://creativecommons.org/licenses/by-nd/4.0)'
published: 2022-03-16
modified_by:
  name: Linode
title: "Configuring IP Failover using lelastic"
contributor:
  name: Linode
---

This guide covers using the Linode provided [lelastic](https://github.com/linode/lelastic) tool to configure IP failover with Linode Compute Instances.

{{<note>}}
Only the Frankfurt (Germany) data center supports IP failover using lelastic. Review the [Configuring IP Failover on a Compute Instance](/docs/guides/ip-failover/) guide to learn more about IP Sharing / IP failover availability within other data centers.
{{</note>}}

## IP Failover Compatibility

Linode's IP failover feature is compatible with various IP address types in certain data centers. Review the list below to learn what types are available in your data center.
...
Before usin to configure IP failover for a public or private IPv4 address (not VLANs), you first need to use Linode's IP Sharing feature to share your IP address with other Compute Instances. To do so, follow the instructions within the **Configuring IP Sharing** section of the [Managing IP Addresses](https://www.linode.com/docs/guides/managing-ip-addresses/#configuring-ip-sharing) guide for *each secondary* Compute Instance.
