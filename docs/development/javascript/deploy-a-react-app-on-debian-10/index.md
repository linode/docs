...
description: 'Learn to deploy a locally developed React application to your Linode using Rsync on Debian 10.'
og_description: 'Use Rsync to deploy a React application from your local computer to a Linode on Debian 10.'
...
modified_by:
  name: Linode
title: "Deploy a React Application on Debian 10"
contributor:
  name: Phil Zona
