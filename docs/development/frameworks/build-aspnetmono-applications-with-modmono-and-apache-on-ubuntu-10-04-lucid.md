...
We recommend using name-based virtual hosts for web hosting. Refer to the Apache documentation for [setting up Name-based virtual hosts](/content/web-servers/apache/apache-2-web-server-on-ubuntu-10-04-lts-lucid#configure-name-based-virtual-hosts).
...
This section assumes that you already have a functioning MySQL installation. Please refer to our [MySQL Installation Guide](/content/databases/mysql/ubuntu-10-04-lucid) for more detailed instructions for installing MySQL, otherwise issue the following command:
