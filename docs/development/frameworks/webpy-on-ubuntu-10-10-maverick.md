...
If you want to upload a more recent version, consider [this procedure](/content/websites/frameworks/webpy-on-ubuntu-12-04-precise-pangolin/ubuntu-10-04-lucid#install_webpy), to install Web.py from source.
