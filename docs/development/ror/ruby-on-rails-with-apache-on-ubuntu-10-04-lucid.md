...
external_resources:
  ...
  - '[Install the Apache HTTP Server on Ubuntu 10.04 (Lucid)](/content/web-servers/apache/installation/ubuntu-10-04-lucid)'
  - '[Install the MySQL Database System on Ubuntu 10.04 (Lucid)](/content/databases/mysql/ubuntu-10-04-lucid)'
---
...
This should install the appropriate versions of all required packages including ruby, rack, and other dependencies needed for basic Rails development. To install support for the [MySQL database system](/content/databases/mysql/ubuntu-10-04-lucid) in Rails, issue the following commands:
