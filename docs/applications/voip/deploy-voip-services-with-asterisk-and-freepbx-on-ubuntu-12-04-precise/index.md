...
4.  Reboot your system to make sure that these changes are applied. You will need to do this before you can proceed. It is a good idea to watch the shutdown and reboot phases via [LISH](/docs/platform/manager/using-the-linode-shell-lish/) to see if there are any errors.
