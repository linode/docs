...
Before installing phpFox, make sure you have set up a [LAMP stack](/content/lamp-guides/debian-5-lenny/). You will also need to install the "curl" and "gd" modules for PHP. Issue the following command:
