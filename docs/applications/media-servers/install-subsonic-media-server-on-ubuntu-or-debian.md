...
This guide shows how to set up [Subsonic](http://subsonic.org) on a Linode running Debian or Ubuntu. If you have a large music library, consider attaching a [Block Storage Volume](/docs/platform/how-to-use-block-storage-with-your-linode/) to your Linode to store your music files.
