...
Before we begin with the installation and configuration of Prosody, we assume that you have a running and up to date installation of Ubuntu Karmic, have completed our [getting started](/content/getting-started/) guide and have logged in via SSH as root.
