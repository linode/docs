...
This installation process assumes that you have a working installation of Debian 5 (Lenny), that you've followed the steps in the [getting started](/content/getting-started/) guide, and that you are connected to your Linode via SSH as the root user. Once you've completed these requirements we can begin with the installation process.
