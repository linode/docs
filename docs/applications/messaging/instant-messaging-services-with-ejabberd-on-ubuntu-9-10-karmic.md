...
In the following example, ejabberd has been configured to host a number of additional domains. In this case "squire.bucknell.net," "bucknell.net," and "ducklington.org."
