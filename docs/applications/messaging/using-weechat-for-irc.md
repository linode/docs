...
external_resources:
 ...
 - '[Screen for Persistent Terminal Sessions](/content/networking/ssh/using-gnu-screen-to-manage-persistent-terminal-sessions)'
---
