...
Before we begin with the installation and configuration of Prosody, we assume that you have a running and up to date installation of Ubuntu Jaunty, have completed our [Getting Started](/content/getting-started/) guide and have logged in via SSH as root.
