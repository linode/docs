...
external_resources:
 ...
 - '[Using the Linode Shell (Lish)](/content/networking/using-the-linode-shell-lish)'
...
![Control Network Traffic with iptables](/content/assets/control-network-traffic-with-iptables.png)
...
UFW is the iptables controller included with Ubuntu, but it is also available in Debian's repositories. If you prefer to use UFW instead of iptables, see our guide: [How to Configure a Firewall with UFW](/content/security/firewalls/configure-firewall-with-ufw).
...
3.  To apply your iptables rules automatically on boot, see our section on configuring [iptables-persistent](/content/security/firewalls/control-network-traffic-with-iptables#introduction-to-iptables-persistent).

### CentOS / Fedora

**CentOS 7 or Fedora 20 and above**

In these distros, FirewallD is used to implement firewall rules instead of using the iptables command. If you prefer to use it over iptables, see our guide: [Introduction to FirewallD on CentOS](/content/security/firewalls/introduction-to-firewalld-on-centos).
...
[![Save IPv4 rules prompt.](/content/assets/1721-ipv4-rules.png)](/content/assets/1721-ipv4-rules.png)

The second prompt is to save the rules configured for IPv6.

[![Save IPv6 rules prompt.](/content/assets/1722-ipv6-rules.png)](/content/assets/1722-ipv6-rules.png)
