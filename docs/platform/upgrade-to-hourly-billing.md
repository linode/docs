...
This guide will show you how to upgrade your prepaid Linode account to use Hourly billing. For more information on Hourly billing, see our [Billing Guide](/content/platform/billing-and-payments).
...
3.  From the **Account** tab, select the **Convert to Hourly billing** link in the lower right.
    ...
    [![Select the Convert to Hourly billing link towards the end of the page.](/content/assets/convert-to-hourly-account-tab-small.png)](/content/assets/convert-to-hourly-account-tab.png)
...
4.  You'll be taken to a page with a brief overview of the Hourly billing system. If you have any prepaid amounts on your account from the current month or year, you will receive that amount as a credit on your account to be used toward future invoices. Click the **Convert me to Hourly NOW!** button to finalize the conversion.
    ...
    [![Review the Hourly billing details and your possible credit amount.](/content/assets/convert-to-hourly-small.png)](/content/assets/convert-to-hourly.png)
...
[![You may receive some notices that "This package needs to be paid."](/content/assets/1616-metered_errors_cropped_sm.png)](/content/assets/1617-metered_errors_cropped.png)
...
-   Check for **extras** packages, and [remove](/content/platform/billing-and-payments#removing-services) them manually
-   [Contact support](/content/support) for other notices on this page
...
[![Please note the annual discounts will go away when converting to Hourly.](/content/assets/convert-to-hourly-annual-small.png)](/content/assets/convert-to-hourly-annual.png)
