...
When taking one of these actions, keep in mind that the quota amount that will be added is [prorated](#why-is-my-linode-s-network-transfer-less-than-my-plans-transfer) according to the current date.
