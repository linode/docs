...
{{< note >}}
If you have other documents which state that your organization's services with Linode should not be taxed, please [contact Linode Support](/docs/platform/billing-and-support/support-classic-manager/#contacting-linode-support).
{{< /note >}}
