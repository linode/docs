...
1.  Click **Save**. It should only take a few minutes for new DNS records to become active.
...
1.  Click **Save**. It should only take a few minutes for the record to be updated.
...
1.  Select **Remove** to permanently delete the domain, including all associated DNS records. It should only take a few minutes for the changes to take effect.
