...
aliases: ['platform/disk-images/disk-images-and-configuration-profiles-classic-manager/','migrate-to-linode/disk-images/disk-images-and-configuration-profiles/','disk-images-config-profiles/']
modified: 2019-07-09
modified_by:
  name: Linode
