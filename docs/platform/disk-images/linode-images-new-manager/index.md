...
1.  Navigate to the **Images** page, click on the ellipsis icon (three dots) to open the menu for the Image from which you would like to deploy, and select **Deploy New Linode**.
