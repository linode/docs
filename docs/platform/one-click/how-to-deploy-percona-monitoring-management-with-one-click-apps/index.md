...
| [**pmm-admin**](https://www.percona.com/doc/percona-monitoring-and-management/pmm-admin.html) | `pmm-admin` is a command-line tool used to manage PMM Clients. |
...
{{< note >}}
The PMM Server deployed with Linode's Percona (PMM) One-Click App is compatible with [**PMM Client version 1**](https://www.percona.com/doc/percona-monitoring-and-management/index.html).
{{</ note >}}
