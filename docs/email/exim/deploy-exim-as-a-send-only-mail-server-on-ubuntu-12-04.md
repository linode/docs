...
[![Exim4 mail delivery type configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1153-011-exim4-ubuntu-12-04-general.png)](/content/assets/1153-011-exim4-ubuntu-12-04-general.png)

3.  Enter your system's FQDN (fully qualified domain name) in the **mail name** configuration screen.

[![Exim4 system mail name configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1154-02-exim4-ubuntu-12-04-mail-name.png)](/content/assets/1154-02-exim4-ubuntu-12-04-mail-name.png)

4.  Enter `127.0.0.1 ; ::1` when asked which IP address to listen on for SMTP connections.

[![Exim4 listening IP address configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1156-03-exim4-ubuntu-12-04-ip-listen.png)](/content/assets/1156-03-exim4-ubuntu-12-04-ip-listen.png)
...
[![Exim4 mail destination configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1157-04-exim4-ubuntu-12-04-local-domains.png)](/content/assets/1157-04-exim4-ubuntu-12-04-local-domains.png)

6.  Leave the relay domains and relay machines fields blank.

[![Exim4 relay domains configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1158-05-exim4-ubuntu-12-04-relay-domains.png)](/content/assets/1158-05-exim4-ubuntu-12-04-relay-domains.png)

7.  Select **No** when asked whether to keep DNS queries to a minimum.

[![Exim4 DNS queries configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1159-06-exim4-ubuntu-12-04-dns-queries.png)](/content/assets/1159-06-exim4-ubuntu-12-04-dns-queries.png)
...
[![Exim4 mail format configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1160-07-exim4-ubuntu-12-04-mail-format.png)](/content/assets/1160-07-exim4-ubuntu-12-04-mail-format.png)
...
[![Exim4 postmaster recipient configuration on Ubuntu 12.04 LTS (Precise).](/content/assets/1161-08-exim4-ubuntu-12-04-postmater-mail.png)](/content/assets/1161-08-exim4-ubuntu-12-04-postmater-mail.png)
