...
[![Exim4 mail delivery type configuration on Debian 6 (Squeeze).](/content/assets/98-debian-6-exim-01-general.png)](/content/assets/98-debian-6-exim-01-general.png)

Enter your system's FQDN (fully qualified domain name) on the "mail name" configuration screen.

[![Exim4 system mail name configuration on Debian 6 (Squeeze).](/content/assets/99-debian-6-exim-02-mail-name.png)](/content/assets/99-debian-6-exim-02-mail-name.png)

Enter "127.0.0.1" when asked which IP address to listen on for SMTP connections.

[![Exim4 listening IP address configuration on Debian 6 (Squeeze).](/content/assets/100-debian-6-exim-03-listen-ip.png)](/content/assets/100-debian-6-exim-03-listen-ip.png)
...
[![Exim4 mail destination configuration on Debian 6 (Squeeze).](/content/assets/101-debian-6-exim-04-recipient-domains.png)](/content/assets/101-debian-6-exim-04-recipient-domains.png)

Leave the relay domains and relay machines fields blank.

[![Exim4 relay domains configuration on Debian 6 (Squeeze).](/content/assets/102-debian-6-exim-05-relay-domains.png)](/content/assets/102-debian-6-exim-05-relay-domains.png)

[![Exim4 relay machines configuration on Debian 6 (Squeeze).](/content/assets/103-debian-6-exim-06-relay-machines.png)](/content/assets/103-debian-6-exim-06-relay-machines.png)

Select "No" when asked whether to keep DNS queries to a minimum.

[![Exim4 DNS queries configuration on Debian 6 (Squeeze).](/content/assets/104-debian-6-exim-07-dns-queries.png)](/content/assets/104-debian-6-exim-07-dns-queries.png)
...
[![Exim4 mail format configuration on Debian 6 (Squeeze).](/content/assets/105-debian-6-exim-08-mail-format.png)](/content/assets/105-debian-6-exim-08-mail-format.png)

Accept the default "non-split" option for your mail configuration file.

[![Exim4 mail configuration file specification on Debian 6 (Squeeze).](/content/assets/106-debian-6-exim-09-split-config.png)](/content/assets/106-debian-6-exim-09-split-config.png)
