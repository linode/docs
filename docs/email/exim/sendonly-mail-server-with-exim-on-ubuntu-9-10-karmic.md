...
[![Exim4 mail delivery type configuration on Ubuntu 9.10 (Karmic).](/content/assets/443-01-exim4-ubuntu-9.10-general.png)](/content/assets/443-01-exim4-ubuntu-9.10-general.png)

Enter your system's FQDN (fully qualified domain name) in the "mail name" configuration screen.

[![Exim4 system mail name configuration on Ubuntu 9.10 (Karmic).](/content/assets/444-02-exim4-ubuntu-9.10-mail-name.png)](/content/assets/444-02-exim4-ubuntu-9.10-mail-name.png)

Enter "127.0.0.1" when asked which IP address to listen on for SMTP connections.

[![Exim4 listening IP address configuration on Ubuntu 9.10 (Karmic).](/content/assets/445-03-exim4-ubuntu-9.10-ip-listen.png)](/content/assets/445-03-exim4-ubuntu-9.10-ip-listen.png)
...
[![Exim4 mail destination configuration on Ubuntu 9.10 (Karmic).](/content/assets/446-04-exim4-ubuntu-9.10-local-domains.png)](/content/assets/446-04-exim4-ubuntu-9.10-local-domains.png)

Leave the relay domains and relay machines fields blank.

[![Exim4 relay domains configuration on Ubuntu 9.10 (Karmic).](/content/assets/447-05-exim4-ubuntu-9.10-relay-domains.png)](/content/assets/447-05-exim4-ubuntu-9.10-relay-domains.png)

[![Exim4 relay machines configuration on Ubuntu 9.10 (Karmic).](/content/assets/448-06-exim4-ubuntu-9.10-relay-machines.png)](/content/assets/448-06-exim4-ubuntu-9.10-relay-machines.png)

Select "No" when asked whether to keep DNS queries to a minimum.

[![Exim4 DNS queries configuration on Ubuntu 9.10 (Karmic).](/content/assets/449-07-exim4-ubuntu-9.10-dns-queries.png)](/content/assets/449-07-exim4-ubuntu-9.10-dns-queries.png)
...
[![Exim4 mail format configuration on Ubuntu 9.10 (Karmic).](/content/assets/450-08-exim4-ubuntu-9.10-mail-format.png)](/content/assets/450-08-exim4-ubuntu-9.10-mail-format.png)

Accept the default "non-split" option for your mail configuration file.

[![Exim4 mail configuration file specification on Ubuntu 9.10 (Karmic).](/content/assets/450-08-exim4-ubuntu-9.10-mail-format.png)](/content/assets/450-08-exim4-ubuntu-9.10-mail-format.png)
...
[![Exim4 postmaster recipient configuration on Ubuntu 9.10 (Karmic).](/content/assets/451-10-exim4-ubuntu-9.10-postmater-mail.png)](/content/assets/451-10-exim4-ubuntu-9.10-postmater-mail.png)
