...
[![Setting the root password for MySQL on a Linux VPS.](/docs/assets/428-postfix-courier-mysql-01-mysql-root-password.png)](/docs/assets/428-postfix-courier-mysql-01-mysql-root-password.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 9.10 (Karmic) Linux VPS.](/docs/assets/429-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/429-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 9.10 (Karmic) Linux VPS.](/docs/assets/430-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/430-postfix-courier-mysql-02-mail-server-type-3.png)
