...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.04 (Lucid) system.](/content/assets/81-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/81-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.04 (Lucid) system.](/content/assets/82-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/82-postfix-courier-mysql-02-mail-server-type-3.png)
...
- [Host Email with Postfix, Dovecot and MySQL on Ubuntu 10.04 (Lucid)](/content/email/postfix/dovecot-mysql-ubuntu-10-04-lucid)
