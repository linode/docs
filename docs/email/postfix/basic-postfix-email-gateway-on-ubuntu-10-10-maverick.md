...
Prior to beginning this document to install a basic Postfix email gateway, it is assumed that you have completed our [getting started guide](/content/getting-started/). If you are new to Linux server administration, you may be interested in our [introduction to Linux concepts guide](/content/tools-reference/introduction-to-linux-concepts/), [beginner's guide](/content/beginners-guide/) and [administration basics guide](/content/using-linux/administration-basics).
...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.04 (Maverick) system.](/content/assets/83-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/83-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.04 (Maverick) system.](/content/assets/84-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/84-postfix-courier-mysql-02-mail-server-type-3.png)
...
- [Host Email with Postfix, Dovecot and MySQL on Ubuntu 10.10 (Maverick)](/content/email/postfix/dovecot-mysql-ubuntu-10-10-maverick)
