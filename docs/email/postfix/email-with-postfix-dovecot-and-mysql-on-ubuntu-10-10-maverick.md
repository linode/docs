...
[![Setting the root password for MySQL on a Linux VPS.](/docs/assets/71-postfix-courier-mysql-ubuntu-10-10-01-mysql-root-password.png)](/docs/assets/71-postfix-courier-mysql-ubuntu-10-10-01-mysql-root-password.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 10.10 (Maverick) Linux VPS.](/docs/assets/72-postfix-courier-mysql-02-mail-server-type-2.png)](/docs/assets/72-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 10.10 (Maverick) Linux VPS.](/docs/assets/73-postfix-courier-mysql-02-mail-server-type-3.png)](/docs/assets/73-postfix-courier-mysql-02-mail-server-type-3.png)
...
> Jan 21 18:58:27 li181-194 postfix/cleanup[7700]: A33BE8372: message-id=\<<20110121185827.A33BE8372@plato.example.com>\> Jan 21 18:58:27 li181-194 postfix/qmgr[7690]: A33BE8372: from=\<<root@plato.example.com>\>, size=432, nrcpt=1 (queue active) Jan 21 18:58:27 li181-194 postfix/pipe[7704]: A33BE8372: to=\<<sales@example.com>\>, relay=dovecot, delay=0.04, delays=0.02/0.01/0/0.01, dsn=2.0.0, status=sent (delivered via dovecot service) Jan 21 18:58:27 li181-194 postfix/qmgr[7690]: A33BE8372: removed
...
> 2011-01-21 18:58:27 deliver(<sales@example.com>): Info: msgid=\<<20110121185827.A33BE8372@plato.example.com>\>: saved mail to INBOX
