...
[![Setting the root password for MySQL on a Linode.](/content/assets/93-postfix-courier-mysql-01-mysql-root-password.png)](/content/assets/93-postfix-courier-mysql-01-mysql-root-password.png)
...
[![Selecting the Postfix mail server configuration type on a Debian 5.0 (Lenny) Linode.](/content/assets/94-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/94-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Debian 5.0 (Lenny) Linode.](/content/assets/95-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/95-postfix-courier-mysql-02-mail-server-type-3.png)

When prompted, select "No" for web-based administration.

[![Declining web-based administration for the Postfix mail server on a Debian 5.0 (Lenny) Linode.](/content/assets/96-postfix-courier-mysql-02-mail-server-type-4.png)](/content/assets/96-postfix-courier-mysql-02-mail-server-type-4.png)
