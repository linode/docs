...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.04 (Lucid) system.](/content/assets/89-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/89-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.04 (Lucid) system.](/content/assets/90-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/90-postfix-courier-mysql-02-mail-server-type-3.png)
...
Consider the [basic email gateway guide](/content/email/postfix/gateway-ubuntu-10-04-lucid) for more information regarding Postfix virtual hosting configuration. If you need to deliver mail locally, continue for documentation of mail routing and the Dovecot POP3/IMAP server.
...
- [Basic Email Gateway with Postfix on Ubuntu 10.04 (Lucid)](/content/email/postfix/gateway-ubuntu-10-04-lucid)
