...
[![Setting the root password for MySQL on a Linode.](431-postfix-courier-mysql-01-mysql-root-password.png)](431-postfix-courier-mysql-01-mysql-root-password.png)

When prompted, select "No" for web-based administration.

[![Declining web-based administration for the Postfix mail server on an Ubuntu 8.04 (Hardy) Linode.](432-postfix-courier-mysql-02-mail-server-type-4.png)](432-postfix-courier-mysql-02-mail-server-type-4.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 8.04 (Hardy) Linode.](433-postfix-courier-mysql-02-mail-server-type-2.png)](433-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 8.04 (Hardy) Linode.](434-postfix-courier-mysql-02-mail-server-type-3.png)](434-postfix-courier-mysql-02-mail-server-type-3.png)
