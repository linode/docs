...
[![Setting the root password for MySQL on a Linode.](/content/assets/435-postfix-courier-mysql-01-mysql-root-password.png)](/content/assets/435-postfix-courier-mysql-01-mysql-root-password.png)

When prompted, select "No" for web-based administration.

[![Declining web-based administration for the Postfix mail server on an Ubuntu 9.04 (Jaunty) Linode.](/content/assets/436-postfix-courier-mysql-02-mail-server-type-4.png)](/content/assets/436-postfix-courier-mysql-02-mail-server-type-4.png)
...
[![Selecting the Postfix mail server configuration type on an Ubuntu 9.04 (Jaunty) Linode.](/content/assets/437-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/437-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on an Ubuntu 9.04 (Jaunty) Linode.](/content/assets/438-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/438-postfix-courier-mysql-02-mail-server-type-3.png)
