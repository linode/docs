...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.10 (Maverick) system.](91-postfix-courier-mysql-02-mail-server-type-2.png)](91-postfix-courier-mysql-02-mail-server-type-2.png)
