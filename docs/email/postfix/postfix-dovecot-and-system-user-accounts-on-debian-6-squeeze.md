...
[![Selecting the Postfix mail server configuration type.](/content/assets/85-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/85-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name.](/content/assets/86-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/86-postfix-courier-mysql-02-mail-server-type-3.png)
...
Issue the following command to install the prerequisites and [generate a self-signed SSL certificate](/content/security/ssl/how-to-make-a-selfsigned-ssl-certificate):
...
Consider the [basic email gateway guide](/content/email/postfix/gateway-debian-6-squeeze) for more information regarding Postfix virtual hosting configuration. If you need to deliver mail locally, continue for documentation of mail routing and the Dovecot POP3/IMAP server.
...
- [Basic Email Gateway with Postfix on Debian 6 (Squeeze)](/content/email/postfix/gateway-debian-6-squeeze)
