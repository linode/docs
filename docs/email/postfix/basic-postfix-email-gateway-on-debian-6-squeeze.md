...
[![Selecting the Postfix mail server configuration type.](/content/assets/77-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/77-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name.](/content/assets/78-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/78-postfix-courier-mysql-02-mail-server-type-3.png)
...
- [Host Email with Postfix, Dovecot and MySQL on Debian 5 (Lenny)](/content/email/postfix/dovecot-mysql-debian-6-squeeze)
