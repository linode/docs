...
[![Selecting the Postfix mail server configuration type on a Ubuntu 10.10 (Maverick) system.](/content/assets/91-postfix-courier-mysql-02-mail-server-type-2.png)](/content/assets/91-postfix-courier-mysql-02-mail-server-type-2.png)
...
[![Selecting the Postfix system mail name on a Ubuntu 10.10 (Maverick) system.](/content/assets/92-postfix-courier-mysql-02-mail-server-type-3.png)](/content/assets/92-postfix-courier-mysql-02-mail-server-type-3.png)
...
Issue the following sequence of commands to install the prerequisites and [generate a self-signed SSL certificate](/content/security/ssl/how-to-make-a-selfsigned-ssl-certificate):
...
At this point you should be able to send email using your Postfix instance by authenticating with SMTP. Authentication credentials are your [system user accounts](/content/tools-reference/linux-users-and-groups/).

Consider the [basic email gateway guide](/content/email/postfix/gateway-ubuntu-10-10-maverick) for more information regarding Postfix virtual hosting configuration. If you need to deliver mail locally, continue for documentation of mail routing and the Dovecot POP3/IMAP server.
...
- [Basic Email Gateway with Postfix on Ubuntu 10.10 (Maverick)](/content/email/postfix/gateway-ubuntu-10-10-maverick)
