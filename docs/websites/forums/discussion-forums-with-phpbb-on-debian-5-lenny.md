...
For this guide, we'll assume you've already followed the [getting started](/content/getting-started/) guide and have a working [LAMP stack](/content/lamp-guides/debian-5-lenny/) on your Linode. You should be connected to your server via SSH and logged in as root.
