...
7. **Optional:** Drupal 8 requires that the Apache2 rewrite module is turned on for naming URLs. This is optional for Drupal 7. To enable rewrites enter the following command:
