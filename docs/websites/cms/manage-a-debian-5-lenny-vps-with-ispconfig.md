...
description: 'Installing and configuring the ISPConfig control panel to maintain your Debian 5 (Lenny) VPS.'
...
title: 'Manage a Debian 5 (Lenny) VPS with ISPConfig'
---
