...
h1_title: Installing Drupal on Ubuntu 18.04 LTS
---
...
3.  Install and configure a [LAMP stack on Ubuntu 18.04](/docs/web-servers/lamp/install-lamp-stack-on-ubuntu-18-04)
...
1.  See Drupal's [download page](https://www.drupal.org/project/drupal) for the exact URL of Drupal 8's core tarball.
    ...
    If you installed and configured your Apache server using [LAMP stack on Ubuntu 18.04](/docs/web-servers/lamp/install-lamp-stack-on-ubuntu-18-04) guide, the publicly accessible DocumentRoot should be located at `/var/www/html/example.com/public_html/`. Change to that directory and download Drupal 8 with wget:
...
2.  Then specify the rewrite conditions for DocumentRoot in Apache's configuration file.
    If you installed and configured your Apache server using [LAMP stack on Ubuntu 18.04](/docs/web-servers/lamp/install-lamp-stack-on-ubuntu-18-04) guide, the configuration file for your site is located at `/etc/apache2/sites-available/example.com.conf`.
