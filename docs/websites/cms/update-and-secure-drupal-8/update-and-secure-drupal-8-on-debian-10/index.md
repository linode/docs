...
1.  Ensure that you have completed the following guides:
    ...
    -   [Install a LAMP stack](/docs/web-servers/lamp/how-to-install-a-lamp-stack-on-debian-10)
    -   [Install and Configure Drupal 8](/docs/websites/cms/drupal/install-and-configure-drupal-on-debian-10)
...
2.  Check the box next to "Put site into maintenance mode." Enter a message if desired, and click **Save Configuration**.
    ...
    ![Put Site into Maintenance Mode](drupal-updates-maintenance2.png)
