...
aliases: ['web-applications/control-panels/ispconfig/ubuntu-10-04-lucid/']
modified: 2011-04-29
modified_by:
  name: Linode
...
You will be asked a series of questions during the installation; please refer to the [Postfix guide](/content/email/postfix/dovecot-mysql-ubuntu-10-04-lucid) to determine what the needs of your system will be. In most cases, the defaults are fine.
...
More information on Webalizer can be found in our [Webalizer documentation](/content/uptime/analytics/webalizer-on-debian-5-lenny).
