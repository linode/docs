...
modified: Wednesday, April 6, 2016
modified_by:
  name: Edward Angert
...
To install Tomcat, issue the following command:
 ...
 {: .note }
>
> OpenJDK will be installed as a dependency when you install the `tomcat8` package. OpenJDK is pulled in by the `default-java` meta package in Ubuntu.
