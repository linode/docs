...
external_resources:
 ...
 - '[Basic Puppet Configuration](http://content.puppetlabs.com/guides/configuring.html)'
 - '[Puppet Manifest Language](http://content.puppetlabs.com/guides/language_tutorial.html)'
 - '[Puppet Dashboard Documentation](http://content.puppetlabs.com/guides/installing_dashboard.html)'
