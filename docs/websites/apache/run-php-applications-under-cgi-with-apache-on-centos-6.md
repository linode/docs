...
description: 'Methods for enabling dynamic content to run as individual users with PHP on CentOS 6.'
keywords: 'php cgi,php apache,php scripts,dynamic apache,web applications'
license: '[CC BY-ND 3.0](http://creativecommons.org/licenses/by-nd/3.0/us/)'
alias: ['web-servers/apache/php-cgi/centos-6/']
modified: Tuesday, January 14th, 2014
modified_by:
  name: Linode
published: 'Tuesday, January 14th, 2014'
title: Run PHP Applications under CGI with Apache on CentOS 6
external_resources:
...
You can now [configure virtual hosting](/docs/web-servers/apache/installation/centos-5#configure_apache) in accordance with the needs of your server. To install the PHP CGI binaries, issue the following command:
