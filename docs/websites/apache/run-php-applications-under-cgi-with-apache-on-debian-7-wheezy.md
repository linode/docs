...
alias: ['web-servers/apache/php-cgi/debian-7-wheezy/']
modified: Monday, January 13th, 2014
modified_by:
  name: Linode
published: 'Monday, January 13th, 2014'
title: 'Run PHP Applications under CGI with Apache on Debian 7 (Wheezy)'
external_resources:
...
You can now [configure virtual hosting](/docs/web-servers/apache/installation/debian-7-wheezy#configure_apache_for_named_based_virtual_hosting) in accordance with the needs of your server. To install the PHP CGI binaries, issue the following command:
