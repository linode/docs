...
We assume you already have Apache running on your Linode. If you don't, you may wish to review our [Apache on Ubuntu 12.04 (Precise Pangolin) guide](/content/websites/apache/apache-2-web-server-on-ubuntu-12-04-lts-precise-pangolin) before proceeding. These steps should be performed as root via a shell session.
...
[![Website running under Apache on Ubuntu 10.04 (Lucid).](/content/assets/1147-proxypass-apache-site.png)](/content/assets/1147-proxypass-apache-site.png)

Here's the site "www.secondsite.org" being served by lighttpd via ProxyPass:

[![Website running under Lighttpd on Ubuntu 10.04 (Lucid).](/content/assets/1149-proxypass-lighttpd-site.png)](/content/assets/1149-proxypass-lighttpd-site.png)
...
[![Web application running under a directory via lighttpd on Ubuntu 10.04 (Lucid).](/content/assets/1150-proxypass-lighttpd-directory.png)](/content/assets/1150-proxypass-lighttpd-directory.png)
