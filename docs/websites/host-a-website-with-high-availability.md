...
4.  To create a private network among your Linodes, you'll need a [private IP address](/content/networking/remote-access#adding-private-ip-addresses) for each.
