...
description: 'Configuring a LAMP stack with Apache, MySQL, PHP and on Ubuntu Linux 10.04 (Lucid).'
keywords: 'ubuntu lamp server,ubuntu 10.04 lamp,lucid lamp,ubuntu web server,ubuntu lucid'
license: '[CC BY-ND 3.0](http://creativecommons.org/licenses/by-nd/3.0/us/)'
alias: ['lamp-guides/ubuntu-10-04-lucid/']
modified: Monday, September 23rd, 2013
modified_by:
  name: Linode
published: 'Thursday, April 29th, 2010'
title: 'LAMP Server on Ubuntu 10.04 (Lucid)'
---



This guide provides step by step instructions for installing a full featured LAMP stack on an Ubuntu 10.04 (Lucid) system. The 10.04 release is the most current LTS (long term support) version of the Ubuntu operating system, and will be supported with security updates until April of 2015.
