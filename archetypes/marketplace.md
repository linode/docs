...
## ______App Name______ Marketplace App
...
You can configure your ____App Name____ App by providing values for the following fields:
...
<!-- the following disclaimer lets the user know how long it will take
     to deploy the app -->
After providing all required Linode Options, click on the **Create** button. **Your ____App Name____ App will complete installation anywhere between 2-5 minutes after your Linode has finished provisioning**.
